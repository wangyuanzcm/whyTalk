...
const electronAPI = {
  ...
  p2p: {
    ...
    handleContactRequest: (params) =>
      electron.ipcRenderer.invoke('p2p:handleContactRequest', params),
    // 群组相关
    ...
    broadcastContactChanges: (changes) =>
      electron.ipcRenderer.invoke('p2p:broadcastContactChanges', changes)
  }
}
