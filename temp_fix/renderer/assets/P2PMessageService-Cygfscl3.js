import { a2 as onMounted, aw as bus, a3 as onUnmounted, u as h, cg as ServContactDelete, H as createVNode, V as createTextVNode, F as Fragment, ch as ServContactEditRemark, t as defineComponent, a1 as ref, z as computed, a5 as createBlock, T as withCtx, ad as isRef, O as unref, a6 as __unplugin_components_3, U as openBlock, aZ as withKeys, M as createBaseVNode, aa as Button, ci as ServContactSearch, ay as p2pConnect } from "./index-CP-MMhae.js";
...
function useContact() {
  ...
  const onDeleteContact = (item, fn) => {
    dialog.create({
      ...
      title: `删除好友`,
      content: () => {
        return createVNode(Fragment, null, [createTextVNode("你要删除与【"), createVNode("span", {
          "style": {
            color: "red"
          }
        }, [item.remark || item.nickname]), createTextVNode("】好友的关系？请注意，删除操作将永久切断与该联系人的消息往来，您将不再接收任何来自他(她)们的信息。")]);
      },
      positiveText: "确定",
      negativeText: "取消",
      positiveButtonProps: {
