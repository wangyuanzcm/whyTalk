...
function tokensFor(d) {
  return new ExternalTokenizer((input) => {
    ...
    if (inString(next, Space)) {
      ...
      input.acceptToken(
        input.next == 46 || input.peek(-word.length - 1) == 46
          ? Identifier
    ...
    for (let option of completions)
      this.addCompletion(
        typeof option == 'string'
          ? nameCompletion(option, 'property', this.idQuote, this.idCaseInsensitive)
          : option
      )
  }
...
function completeFromSchema(
  ...
  var _a
  let idQuote =
    ((_a = dialect2 === null || dialect2 === void 0 ? void 0 : dialect2.spec.identifierQuotes) ===
      null || _a === void 0
      ? void 0
      : _a[0]) || '"'
  let top = new CompletionLevel(
    idQuote,
    !!(dialect2 === null || dialect2 === void 0 ? void 0 : dialect2.spec.caseInsensitiveIdentifiers)
  )
...
function completeKeywords(keywords2, upperCase, build) {
  let completions = Object.keys(keywords2).map((keyword) =>
    build(upperCase ? keyword.toUpperCase() : keyword, completionType(keywords2[keyword]))
  )
  return ifNotIn(
...
const MSSQL = /* @__PURE__ */ SQLDialect.define({
  keywords:
    SQLKeywords + // Reserved Keywords https://learn.microsoft.com/en-us/sql/t-sql/language-elements/reserved-keywords-transact-sql?view=sql-server-ver17
