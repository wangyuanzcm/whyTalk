...
function L(t) {
  ...
  return new Promise((i, s) => {
    if (t.src)
      if (/^data\:/i.test(t.src)) ((e = k(t.src)), i(e))
        ...
        ;((o.onload = function () {
          if (this.status == 200 || this.status === 0) ((e = o.response), i(e))
          else throw 'Could not load image'
          o = null
        }),
          o.open('GET', t.src, true),
...
function k(t, e) {
  ...
  for (
    var i = atob(t),
      s = i.length % 2 == 0 ? i.length : i.length + 1,
      r = new ArrayBuffer(s),
      o = new Uint16Array(r),
      h = 0;
    h < s;
  ...
  if (
    (c &&
      ...
      T(e, r, 4) === 'Exif' &&
        ...
        (a = n === 18761),
        (a || n === 19789) &&
          e.getUint16(o + 2, a) === 42 &&
          ((h = e.getUint32(o + 4, a)), h >= 8 && (l = o + h)))),
    l)
  ) {
    ...
    */
      ...
      cropInfo() {
        ...
        if (
          ...
          ;(this.high && !this.full && (e = window.devicePixelRatio),
            (this.enlarge !== 1) & !this.full && (e = Math.abs(Number(this.enlarge))),
            (t.width = t.width * e),
            (t.height = t.height * e),
        ...
        HTMLCanvasElement.prototype.toBlob ||
          Object.defineProperty(HTMLCanvasElement.prototype, 'toBlob', {
            value: function (i, s, r) {
              for (
                var o = atob(this.toDataURL(s, r).split(',')[1]),
                  h = o.length,
                  a = new Uint8Array(h),
                  n = 0;
                n < h;
    ...
    methods: {
      ...
      checkedImg() {
        ...
        if (
          ((t.onload = () => {
            if (this.img === '') return (this.$emit('img-load', new Error('图片不能为空')), false)
            let i = t.width,
              s = t.height
            Y.getData(t)
              .then((r) => {
                ...
                ;(i > o && ((s = (s / i) * o), (i = o)),
                  s > o && ((i = (i / s) * o), (s = o)),
                  this.checkOrientationImage(t, this.orientation, i, s))
              })
              .catch((r) => {
      ...
      startMove(t) {
        if ((t.preventDefault(), this.move && !this.crop)) {
          ...
          ((this.cropping = true),
            ...
            (this.cropOffsertY = t.offsetY
              ? t.offsetY
              : t.touches[0].pageY - this.$refs.cropper.offsetTop),
      ...
      touchScale(t) {
        ...
        var i = {
          ...
          n = a - h,
          c = 1
        ;((c = c / this.trueWidth > c / this.trueHeight ? c / this.trueHeight : c / this.trueWidth),
          (c = c > 0.1 ? 0.1 : c))
        var l = c * n
        if (!this.touchNow) {
          if (
            ((this.touchNow = true),
            n > 0 ? (e += Math.abs(l)) : n < 0 && e > Math.abs(l) && (e -= Math.abs(l)),
            (this.touches = t.touches),
            setTimeout(() => {
              this.touchNow = false
            }, 8),
      ...
      moveImg(t) {
        ...
        let e = 'clientX' in t ? t.clientX : t.touches[0].clientX,
        ...
        ;((s = e - this.moveX),
          ...
          this.$nextTick(() => {
            if (this.centerBox) {
              let o = this.getImgAxis(s, r, this.scale),
                h = this.getCropAxis(),
                a = this.trueHeight * this.scale,
              ...
              switch (this.rotate) {
                ...
                case 3:
                case -3:
                  ;((c = this.cropOffsertX - (this.trueWidth * (1 - this.scale)) / 2 + (a - n) / 2),
                    (l =
                      this.cropOffsertY - (this.trueHeight * (1 - this.scale)) / 2 + (n - a) / 2),
                    (f = c - a + this.cropW),
                    (p = l - n + this.cropH))
                  break
                default:
                  ;((c = this.cropOffsertX - (this.trueWidth * (1 - this.scale)) / 2),
                    (l = this.cropOffsertY - (this.trueHeight * (1 - this.scale)) / 2),
                    (f = c - n + this.cropW),
                    (p = l - a + this.cropH))
                  break
              }
      ...
      changeScale(t) {
        ...
        if (
          ((i =
            i / this.trueWidth > i / this.trueHeight ? i / this.trueHeight : i / this.trueWidth),
          (t = t * i),
          t > 0 ? (e += Math.abs(t)) : e > Math.abs(t) && (e -= Math.abs(t)),
          !this.checkoutImgAxis(this.x, this.y, e))
        )
          return false
        this.scale = e
      ...
      createCrop(t) {
        ...
        this.$nextTick(() => {
          ...
          if (
            (s > 0
              ? ((this.cropW = s + this.cropChangeX > this.w ? this.w - this.cropChangeX : s),
                (this.cropOffsertX = this.cropChangeX))
              : ((this.cropW =
                  this.w - this.cropChangeX + Math.abs(s) > this.w
                    ? this.cropChangeX
                    : Math.abs(s)),
                (this.cropOffsertX = this.cropChangeX + s > 0 ? this.cropChangeX + s : 0)),
            !this.fixed)
          )
            r > 0
              ? ((this.cropH = r + this.cropChangeY > this.h ? this.h - this.cropChangeY : r),
                (this.cropOffsertY = this.cropChangeY))
              : ((this.cropH =
                  this.h - this.cropChangeY + Math.abs(r) > this.h
                    ? this.cropChangeY
                    : Math.abs(r)),
                (this.cropOffsertY = this.cropChangeY + r > 0 ? this.cropChangeY + r : 0))
          else {
            var o = (this.cropW / this.fixedNumber[0]) * this.fixedNumber[1]
            ;(o + this.cropOffsertY > this.h
      ...
      changeCropNow(t) {
        ...
        this.$nextTick(() => {
          ...
          if (
            (this.canChangeX &&
              (this.changeCropTypeX === 1
                ? this.cropOldW - c < a
                  ? ((this.cropW = a),
                    (this.cropOffsertX = this.cropOldW + this.cropChangeX - o - a))
                  : this.cropOldW - c > 0
                    ? ((this.cropW =
                        s - this.cropChangeX - c <= s - o
                          ? this.cropOldW - c
                          : this.cropOldW + this.cropChangeX - o),
                      (this.cropOffsertX =
                        s - this.cropChangeX - c <= s - o ? this.cropChangeX + c : o))
                    : ((this.cropW =
                        Math.abs(c) + this.cropChangeX <= s
                          ? Math.abs(c) - this.cropOldW
                          : s - this.cropOldW - this.cropChangeX),
                ...
                : this.changeCropTypeX === 2 &&
                  (this.cropOldW + c < a
                    ...
                    : this.cropOldW + c > 0
                      ? ((this.cropW =
                          this.cropOldW + c + this.cropOffsertX <= s
                            ? this.cropOldW + c
                            : s - this.cropOffsertX),
                        (this.cropOffsertX = this.cropChangeX))
                      : ((this.cropW =
                          s - this.cropChangeX + Math.abs(c + this.cropOldW) <= s - o
                            ? Math.abs(c + this.cropOldW)
                            : this.cropChangeX - o),
                        (this.cropOffsertX =
                          s - this.cropChangeX + Math.abs(c + this.cropOldW) <= s - o
                            ? this.cropChangeX - Math.abs(c + this.cropOldW)
                            : o)))),
            this.canChangeY &&
              (this.changeCropTypeY === 1
                ? this.cropOldH - l < n
                  ? ((this.cropH = n),
                    (this.cropOffsertY = this.cropOldH + this.cropChangeY - h - n))
                  : this.cropOldH - l > 0
                    ? ((this.cropH =
                        r - this.cropChangeY - l <= r - h
                          ? this.cropOldH - l
                          : this.cropOldH + this.cropChangeY - h),
                      (this.cropOffsertY =
                        r - this.cropChangeY - l <= r - h ? this.cropChangeY + l : h))
                    : ((this.cropH =
                        Math.abs(l) + this.cropChangeY <= r
                          ? Math.abs(l) - this.cropOldH
                          : r - this.cropOldH - this.cropChangeY),
                ...
                : this.changeCropTypeY === 2 &&
                  (this.cropOldH + l < n
                    ...
                    : this.cropOldH + l > 0
                      ? ((this.cropH =
                          this.cropOldH + l + this.cropOffsertY <= r
                            ? this.cropOldH + l
                            : r - this.cropOffsertY),
                        (this.cropOffsertY = this.cropChangeY))
                      : ((this.cropH =
                          r - this.cropChangeY + Math.abs(l + this.cropOldH) <= r - h
                            ? Math.abs(l + this.cropOldH)
                            : this.cropChangeY - h),
                        (this.cropOffsertY =
                          r - this.cropChangeY + Math.abs(l + this.cropOldH) <= r - h
                            ? this.cropChangeY - Math.abs(l + this.cropOldH)
                            : h)))),
            ...
            f < n
              ...
              : f + this.cropOffsertY > r
                ? ((this.cropH = r - this.cropOffsertY),
                  (this.cropW = (this.cropH / this.fixedNumber[1]) * this.fixedNumber[0]),
                  this.changeCropTypeX === 1 &&
                    (this.cropOffsertX = this.cropChangeX + (this.cropOldW - this.cropW)))
                : (this.cropH = f)
          ...
          if (this.canChangeY && this.fixed) {
            ...
            p < a
              ? ((this.cropW = a),
                (this.cropH = (this.fixedNumber[1] * a) / this.fixedNumber[0]),
                (this.cropOffsertY = this.cropOldH + this.cropChangeY - this.cropH))
              : p + this.cropOffsertX > s
                ? ((this.cropW = s - this.cropOffsertX),
      ...
      checkCropLimitSize() {
        let { cropW: t, cropH: e, limitMinSize: i } = this,
          s = []
        return (
          Array.isArray(i) ? (s = i) : (s = [i, i]),
          (t = parseFloat(s[0])),
          (e = parseFloat(s[1])),
          [t, e]
        )
      ...
      calculateSize(t, e, i, s, r, o) {
        ...
        let a = r,
          n = o
        return (
          a < i && ((a = i), (n = Math.ceil(a / h))),
          n < s && ((n = s), (a = Math.ceil(n * h)), a < i && ((a = i), (n = Math.ceil(a / h)))),
          a < r && ((a = r), (n = Math.ceil(a / h))),
          n < o && ((n = o), (a = Math.ceil(n * h))),
          { width: a, height: n }
        )
      },
      // 创建完成
      endCrop() {
        ...
        const { width: i, height: s } = this.fixed
          ? this.calculateSize(
              this.fixedNumber[0],
              this.fixedNumber[1],
              t,
          ...
          : { width: t, height: e }
        ;(i > this.cropW &&
          ((this.cropW = i), this.cropOffsertX + i > this.w && (this.cropOffsertX = this.w - i)),
          s > this.cropH &&
            ((this.cropH = s), this.cropOffsertY + s > this.h && (this.cropOffsertY = this.h - s)),
      ...
      cropMove(t) {
        ...
        let e = 'clientX' in t ? t.clientX : t.touches[0].clientX,
          ...
          s,
          r
        ;((s = e - this.cropOffsertX),
          (r = i - this.cropOffsertY),
          (this.cropX = s),
          (this.cropY = r),
      ...
      moveCrop(t, e) {
        ...
        ;(t &&
          ...
          (s = 'clientY' in t ? t.clientY : t.touches[0].clientY)),
          this.$nextTick(() => {
            let r,
              o,
              h = i - this.cropX,
              a = s - this.cropY
            if (
              (e && ((h = this.cropOffsertX), (a = this.cropOffsertY)),
              h <= 0 ? (r = 0) : h + this.cropW > this.w ? (r = this.w - this.cropW) : (r = h),
              a <= 0 ? (o = 0) : a + this.cropH > this.h ? (o = this.h - this.cropH) : (o = a),
              this.centerBox)
            ) {
              let n = this.getImgAxis()
              ;(r <= n.x1 && (r = n.x1),
                r + this.cropW > n.x2 && (r = n.x2 - this.cropW),
                o <= n.y1 && (o = n.y1),
                o + this.cropH > n.y2 && (o = n.y2 - this.cropH))
            }
            ;((this.cropOffsertX = r),
              (this.cropOffsertY = o),
              this.$emit('crop-moving', {
      ...
      getImgAxis(t, e, i) {
        ...
        switch (this.rotate) {
          case 0:
            ;((s.x1 = t + (this.trueWidth * (1 - i)) / 2),
              (s.x2 = s.x1 + this.trueWidth * i),
              (s.y1 = e + (this.trueHeight * (1 - i)) / 2),
              (s.y2 = s.y1 + this.trueHeight * i))
            break
          case 1:
          case -1:
          case 3:
          case -3:
            ;((s.x1 = t + (this.trueWidth * (1 - i)) / 2 + (r - o) / 2),
              (s.x2 = s.x1 + this.trueHeight * i),
              (s.y1 = e + (this.trueHeight * (1 - i)) / 2 + (o - r) / 2),
              (s.y2 = s.y1 + this.trueWidth * i))
            break
          default:
            ;((s.x1 = t + (this.trueWidth * (1 - i)) / 2),
              (s.x2 = s.x1 + this.trueWidth * i),
      ...
      getCropChecked(t) {
        ...
        s.onload = () => {
          if (this.cropW !== 0) {
            ...
            let d = this.cropW * p,
              ...
              u = o * this.scale * p,
              g = h * this.scale * p,
              m = (this.x - a + (this.trueWidth * (1 - this.scale)) / 2) * p,
              v = (this.y - n + (this.trueHeight * (1 - this.scale)) / 2) * p
            switch ((f(d, C), i.save(), r)) {
              case 0:
                this.full
                  ? (f(d / this.scale, C / this.scale),
                    i.drawImage(s, m / this.scale, v / this.scale, u / this.scale, g / this.scale))
              ...
              case -3:
                this.full
                  ? (f(d / this.scale, C / this.scale),
                    (m = m / this.scale + (u / this.scale - g / this.scale) / 2),
                    (v = v / this.scale + (g / this.scale - u / this.scale) / 2),
                    i.rotate((r * 90 * Math.PI) / 180),
                    i.drawImage(s, v, -m - g / this.scale, u / this.scale, g / this.scale))
                  : ((m = m + (u - g) / 2),
                    (v = v + (g - u) / 2),
                    i.rotate((r * 90 * Math.PI) / 180),
                    i.drawImage(s, v, -m - g, u, g))
                break
              case 2:
              case -2:
                this.full
              ...
              case -1:
                this.full
                  ? (f(d / this.scale, C / this.scale),
                    ...
                    (v = v / this.scale + (g / this.scale - u / this.scale) / 2),
                    i.rotate((r * 90 * Math.PI) / 180),
                    i.drawImage(s, -v - u / this.scale, m, u / this.scale, g / this.scale))
                  : ((m = m + (u - g) / 2),
                    (v = v + (g - u) / 2),
                    i.rotate((r * 90 * Math.PI) / 180),
                    i.drawImage(s, -v - u, m, u, g))
                break
              default:
                this.full
                  ? (f(d / this.scale, C / this.scale),
        ...
        function f(p, d) {
          ;((e.width = Math.round(p)),
            (e.height = Math.round(d)),
            l && ((i.fillStyle = l), i.fillRect(0, 0, e.width, e.height)))
        }
      },
      // 获取转换成base64 的图片信息
      getCropData(t) {
      ...
      showPreview() {
        ...
        let r = (this.x - this.cropOffsertX) / i,
        ...
        switch (s[0]) {
          ...
          case 'cover':
            ;((e = this.w),
              (t = e / this.trueWidth),
              (i = i * t),
              i < this.h && ((i = this.h), (t = i / this.trueHeight)))
            break
          default:
            try {
              let r = s[0]
              if (r.search('px') !== -1) {
                ...
                let h = 1,
                  a = s[1]
                ;(a.search('px') !== -1 &&
                  ((a = a.replace('px', '')), (i = parseFloat(a)), (h = i / this.trueHeight)),
                  (t = Math.min(o, h)))
              }
              if (
                (r.search('%') !== -1 &&
                  ((r = r.replace('%', '')),
                  (e = (parseFloat(r) / 100) * this.w),
                  (t = e / this.trueWidth)),
                s.length === 2 && r === 'auto')
              ) {
                let o = s[1]
                ;(o.search('px') !== -1 &&
                  ((o = o.replace('px', '')), (i = parseFloat(o)), (t = i / this.trueHeight)),
                  o.search('%') !== -1 &&
                    ((o = o.replace('%', '')),
                    (i = (parseFloat(o) / 100) * this.h),
                    (t = i / this.trueHeight)))
              }
            } catch {
              t = 1
      ...
      goAutoCrop(t, e) {
        ...
        if (this.centerBox) {
          ...
          let a = (h ? this.trueHeight : this.trueWidth) * this.scale,
            n = (h ? this.trueWidth : this.trueHeight) * this.scale
          ;((i = a < i ? a : i), (s = n < s ? n : s))
        }
        var r = t || parseFloat(this.autoCropWidth),
          o = e || parseFloat(this.autoCropHeight)
        ;((r === 0 || o === 0) && ((r = i * 0.8), (o = s * 0.8)),
          (r = r > i ? i : r),
          (o = o > s ? s : o),
          this.fixed && (o = (r / this.fixedNumber[0]) * this.fixedNumber[1]),
          o > this.h && ((o = this.h), (r = (o / this.fixedNumber[1]) * this.fixedNumber[0])),
          this.changeCrop(r, o))
      },
      // 手动改变截图框大小函数
      changeCrop(t, e) {
        if (this.centerBox) {
          ...
          ;(t > i.x2 - i.x1 &&
            ((t = i.x2 - i.x1), (e = (t / this.fixedNumber[0]) * this.fixedNumber[1])),
            e > i.y2 - i.y1 &&
              ((e = i.y2 - i.y1), (t = (e / this.fixedNumber[1]) * this.fixedNumber[0])))
        }
        ;((this.cropW = t),
          (this.cropH = e),
          ...
          this.$nextTick(() => {
            ;((this.cropOffsertX = (this.w - this.cropW) / 2),
              ...
              this.centerBox && this.moveCrop(null, true))
          }))
      },
      // 重置函数， 恢复组件置初始状态
      refresh() {
      ...
      checkoutImgAxis(t, e, i) {
        ...
        let s = true
        if (this.centerBox) {
          let r = this.getImgAxis(t, e, i),
            o = this.getCropAxis()
          ;(r.x1 >= o.x1 && (s = false),
            r.x2 <= o.x2 && (s = false),
            r.y1 >= o.y1 && (s = false),
            r.y2 <= o.y2 && (s = false),
            s || this.changeImgScale(r, o, i))
        }
        return s
      },
      // 缩放图片，将图片坐标适配截图框坐标
      changeImgScale(t, e, i) {
        let s = this.trueWidth,
          r = this.trueHeight,
          o = s * i,
          h = r * i
        if (o >= this.cropW && h >= this.cropH) this.scale = i
        else {
          const a = this.cropW / s,
            n = this.cropH / r,
        ...
        ;(this.imgIsQqualCrop ||
          (t.x1 >= e.x1 &&
            (this.isRotateRightOrLeft
              ? (this.x = e.x1 - (s - o) / 2 - (o - h) / 2)
              : (this.x = e.x1 - (s - o) / 2)),
          t.x2 <= e.x2 &&
            (this.isRotateRightOrLeft
              ? (this.x = e.x1 - (s - o) / 2 - (o - h) / 2 - h + this.cropW)
              : (this.x = e.x2 - (s - o) / 2 - o)),
          t.y1 >= e.y1 &&
            (this.isRotateRightOrLeft
              ? (this.y = e.y1 - (r - h) / 2 - (h - o) / 2)
              : (this.y = e.y1 - (r - h) / 2)),
          t.y2 <= e.y2 &&
            (this.isRotateRightOrLeft
              ? (this.y = e.y2 - (r - h) / 2 - (h - o) / 2 - o)
              : (this.y = e.y2 - (r - h) / 2 - h))),
          (o < this.cropW || h < this.cropH) && (this.imgIsQqualCrop = true))
      }
    }
  }),
  A = {
              ...
              t.info
                ? (openBlock(),
                  createElementBlock(
                    ...
                    toDisplayString(t.cropInfo.width) + ' × ' + toDisplayString(t.cropInfo.height),
                    5
                  ))
                : createCommentVNode('', true),
              t.fixedBox
                  ...
                  createElementBlock('span', D, [
                    ...
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[10] || (e[10] = (h) => t.changeCropSize(h, true, false, 2, 0)),
                        onTouchstart:
                          e[11] || (e[11] = (h) => t.changeCropSize(h, true, false, 2, 0))
                      },
                      null,
                      32
                    ),
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[12] || (e[12] = (h) => t.changeCropSize(h, true, true, 1, 1)),
                        onTouchstart:
                          e[13] || (e[13] = (h) => t.changeCropSize(h, true, true, 1, 1))
                      },
                      null,
                      32
                    ),
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[14] || (e[14] = (h) => t.changeCropSize(h, false, true, 0, 1)),
                        onTouchstart:
                          e[15] || (e[15] = (h) => t.changeCropSize(h, false, true, 0, 1))
                      },
                      null,
                      32
                    ),
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[16] || (e[16] = (h) => t.changeCropSize(h, true, true, 2, 1)),
                        onTouchstart:
                          e[17] || (e[17] = (h) => t.changeCropSize(h, true, true, 2, 1))
                      },
                      null,
                      32
                    ),
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[18] || (e[18] = (h) => t.changeCropSize(h, true, false, 1, 0)),
                        onTouchstart:
                          e[19] || (e[19] = (h) => t.changeCropSize(h, true, false, 1, 0))
                      },
                      null,
                      32
                    ),
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[20] || (e[20] = (h) => t.changeCropSize(h, true, false, 2, 0)),
                        onTouchstart:
                          e[21] || (e[21] = (h) => t.changeCropSize(h, true, false, 2, 0))
                      },
                      null,
                      32
                    ),
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[22] || (e[22] = (h) => t.changeCropSize(h, true, true, 1, 2)),
                        onTouchstart:
                          e[23] || (e[23] = (h) => t.changeCropSize(h, true, true, 1, 2))
                      },
                      null,
                      32
                    ),
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[24] || (e[24] = (h) => t.changeCropSize(h, false, true, 0, 2)),
                        onTouchstart:
                          e[25] || (e[25] = (h) => t.changeCropSize(h, false, true, 0, 2))
                      },
                      null,
                      32
                    ),
                    createBaseVNode(
                      'span',
                      {
                        ...
                        onMousedown:
                          e[26] || (e[26] = (h) => t.changeCropSize(h, true, true, 2, 2)),
                        onTouchstart:
                          e[27] || (e[27] = (h) => t.changeCropSize(h, true, true, 2, 2))
                      },
                      null,
                      32
                    )
                        ...
                        createBaseVNode('section', _hoisted_6, [
                          ...
                          createBaseVNode('main', _hoisted_8, [
                            createVNode(
                              ...
                              {
                                default: withCtx(
                                  () => _cache[6] || (_cache[6] = [createTextVNode('保存头像', -1)])
                                ),
                                _: 1,
                                __: [6]
                              }
