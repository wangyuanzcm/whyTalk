import { I as IconWrapper, H as createVNode, z as computed, e0 as toValue, cZ as shallowRef, ah as watch, a2 as onMounted, bh as getCurrentInstance, t as defineComponent, L as createElementBlock, U as openBlock, O as unref, F as Fragment, a5 as createBlock, a8 as createCommentVNode, aV as resolveDynamicComponent, R as toDisplayString, e1 as humanizeTime, ac as normalizeClass, P as withDirectives, M as createBaseVNode, Q as vShow, aC as resolveComponent, aL as withModifiers, N as NIcon, W as _export_sfc, $ as mergeModels, a0 as useModel, aj as useTemplateRef, a3 as onUnmounted, a1 as ref, a4 as reactive, dl as renderSlot, d2 as normalizeStyle, u as h, bC as nextTick, cY as useId, T as withCtx, a9 as renderList, e2 as ChatMsgSysGroupMemberCancelMuted, e3 as ChatMsgSysGroupMemberMuted, e4 as ChatMsgSysGroupCancelMuted, e5 as ChatMsgSysGroupMuted, e6 as ChatMsgSysGroupMemberKicked, e7 as ChatMsgSysGroupMemberQuit, e8 as ChatMsgSysGroupMemberJoin, e9 as ChatMsgSysGroupCreate, ea as ChatMsgSysText, eb as ChatMsgTypeGroupNotice, ec as ChatMsgTypeMixed, ar as ChatMsgTypeVote, ed as ChatMsgTypeLogin, ao as ChatMsgTypeForward, an as ChatMsgTypeFile, am as ChatMsgTypeVideo, al as ChatMsgTypeAudio, ak as ChatMsgTypeImage, ap as ChatMsgTypeCode, ee as ChatMsgTypeText } from "./index-CP-MMhae.js";
...
import { t as toArray, n as notNullish, a as noop, b as tryOnScopeDispose, i as isClient } from "./index-88uWzgFD.js";
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return _ctx.item.role == "system" ? (openBlock(), createElementBlock("div", _hoisted_1$4, [
        _ctx.item.type === unref(MessageTypeEnum).CUSTOM ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          _ctx.item.render ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.item.render()), { key: 0 })) : createCommentVNode("", true)
        ], 64)) : _ctx.item.type === unref(MessageTypeEnum).TEXT ? (openBlock(), createElementBlock("span", _hoisted_2$3, toDisplayString(_ctx.item.content), 1)) : _ctx.item.type === unref(MessageTypeEnum).TIME ? (openBlock(), createElementBlock("span", _hoisted_3$2, "― " + toDisplayString(unref(humanizeTime)(new Date(_ctx.item.time).getTime())) + " ―", 1)) : (openBlock(), createElementBlock("span", _hoisted_4$2, "未知类型"))
      ])) : (openBlock(), createElementBlock("div", {
        key: 1,
        class: normalizeClass(["chat-container-item", {
          "align-right": _ctx.align === unref(AlignEnum).LEFT_RIGHT && _ctx.item.role === unref(RoleEnum).USER,
        ...
        withDirectives(createBaseVNode("div", _hoisted_5, [
          createVNode(_component_n_checkbox, {
            ...
            "onUpdate:checked": _cache[0] || (_cache[0] = () => {
        ...
        withDirectives(createBaseVNode("div", _hoisted_6, [
          createVNode(_component_im_avatar, {
            ...
            "font-size": 14,
            onClick: _cache[1] || (_cache[1] = ($event) => emits("click-avatar", _ctx.raw))
          }, null, 8, ["src", "username"])
        ], 512), [
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_7, [
            createBaseVNode("span", {
              class: "name",
              onClick: _cache[2] || (_cache[2] = ($event) => emits("click-name", _ctx.raw))
            }, toDisplayString(_ctx.item.name), 1),
            createBaseVNode("span", {
              class: "time",
              datetime: _ctx.item.time
            }, toDisplayString(unref(humanizeTime)(new Date(_ctx.item.time).getTime())), 9, _hoisted_8)
          ]),
          createBaseVNode("div", _hoisted_9, [
            createBaseVNode("div", _hoisted_10, [
              _ctx.item.type === unref(MessageTypeEnum).CUSTOM ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                _ctx.item.render ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.item.render()), {
                  key: 0,
                  class: "immsg",
                  onContextmenu: _cache[3] || (_cache[3] = withModifiers(($event) => _ctx.onContextMenu($event, _ctx.raw), ["prevent"]))
                }, null, 32)) : createCommentVNode("", true)
              ], 64)) : _ctx.item.type === unref(MessageTypeEnum).TEXT ? (openBlock(), createElementBlock("div", _hoisted_11, toDisplayString(_ctx.item.content || ""), 1)) : (openBlock(), createElementBlock("div", _hoisted_12, "未知类型")),
              _ctx.item?.status === unref(StatusEnum).SENDING ? (openBlock(), createElementBlock("span", _hoisted_13, [
                createVNode(_component_n_icon, { component: unref(LoadingTwo) }, null, 8, ["component"])
              ])) : createCommentVNode("", true),
              _ctx.item?.status === unref(StatusEnum).ERROR ? (openBlock(), createElementBlock("span", _hoisted_14, "发送失败")) : createCommentVNode("", true)
            ]),
            _ctx.item.quote?.quote_id ? (openBlock(), createElementBlock("div", _hoisted_15, [
              createVNode(_component_n_icon, {
                component: unref(ToTop),
                size: "22"
              }, null, 8, ["component"]),
              createBaseVNode("span", null, "回复：" + toDisplayString(_ctx.item?.quote?.content), 1)
            ])) : createCommentVNode("", true),
            _ctx.showToolsMenus ? (openBlock(), createElementBlock("div", _hoisted_16, [
              createVNode(_component_n_icon, {
                class: "pointer",
                component: unref(Copy),
                onClick: _cache[4] || (_cache[4] = ($event) => emits("element-event", "copy", _ctx.raw)),
                size: "16"
              }, null, 8, ["component"]),
              createVNode(_component_n_icon, {
                class: "pointer",
                component: unref(IconDelete),
                onClick: _cache[5] || (_cache[5] = ($event) => emits("element-event", "delete", _ctx.raw)),
                size: "16"
              }, null, 8, ["component"]),
              createVNode(_component_n_icon, {
                class: "pointer",
                component: unref(Undo),
                onClick: _cache[6] || (_cache[6] = ($event) => emits("element-event", "revoke", _ctx.raw)),
                size: "16"
              }, null, 8, ["component"])
            ])) : createCommentVNode("", true)
          ])
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        _ctx.loadMode === "pullup" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          _ctx.loadStatus === 3 ? (openBlock(), createElementBlock("span", _hoisted_2$2, "― 没有更多消息 ―")) : _ctx.loadStatus === 2 ? (openBlock(), createElementBlock("span", _hoisted_3$1, "加载数据中...")) : (openBlock(), createElementBlock("span", _hoisted_4$1, "加载更多消息"))
        ], 64)) : createCommentVNode("", true)
      ], 512);
    };
  }
});
const FooterLoadToolbar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-2d048bf4"]]);
const _hoisted_1$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        _ctx.loadStatus === 3 ? (openBlock(), createElementBlock("span", _hoisted_2$1, "― 没有更多消息 ―")) : _ctx.loadStatus === 2 ? (openBlock(), createElementBlock("span", _hoisted_3, "加载数据中...")) : (openBlock(), createElementBlock("span", _hoisted_4, "加载更多消息"))
      ], 512);
    };
  }
});
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.unread ? (openBlock(), createElementBlock("span", _hoisted_1$1, toDisplayString(_ctx.unread) + " 条未读消息", 1)) : (openBlock(), createElementBlock("span", _hoisted_2, "回到底部")),
        createVNode(_component_n_icon, {
          size: "14",
          color: "#fff",
...
const SkipBottomButton = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-a2fa1a60"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    const isElementSelected = (elementRect, selectBoxRect) => {
      switch (props.strategy) {
        case "intersect":
          return elementRect.left < selectBoxRect.right && elementRect.right > selectBoxRect.left && elementRect.top < selectBoxRect.bottom && elementRect.bottom > selectBoxRect.top;
        case "contain":
          return elementRect.left >= selectBoxRect.left && elementRect.right <= selectBoxRect.right && elementRect.top >= selectBoxRect.top && elementRect.bottom <= selectBoxRect.bottom;
        default:
          return false;
      }
    };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["user-click-event", "context-menu-event", "element-event", "element-select", "on-scroll-to-bottom"],
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { loadStatus, toLoadMore } = useLoadMore(__props.dataSourceMode, container, __props.onScrollLoadMore);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1, [
        createVNode(DraggableArea, {
          ...
          default: withCtx(() => [
            _ctx.dataSourceMode === "pulldown" ? (openBlock(), createBlock(HeaderToolbar, {
              key: 0,
              "load-status": unref(loadStatus),
              fn: unref(toLoadMore)
            }, null, 8, ["load-status", "fn"])) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
              return openBlock(), createBlock(ChatItem, {
                key: item.msg_id,
              ...
              }, null, 8, ["data-index", "align", "show-checkbox", "show-avatar", "item", "raw", "is-selected", "onSelectedElement", "showToolsMenus"]);
            }), 128)),
            createVNode(FooterLoadToolbar, {
              modelValue: isScrollBottom.value,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => isScrollBottom.value = $event),
              "load-mode": _ctx.dataSourceMode,
              "load-status": unref(loadStatus),
              fn: unref(toLoadMore)
            }, null, 8, ["modelValue", "load-mode", "load-status", "fn"])
          ]),
          _: 1
        }, 8, ["enable"]),
        createVNode(unref(ContextMenuElement)),
        _ctx.dataSourceMode === "pulldown" ? (openBlock(), createBlock(SkipBottomButton, {
          key: 0,
          show: !isScrollBottom.value,
          unread: _ctx.unread,
          scrollToBottom
        }, null, 8, ["show", "unread"])) : createCommentVNode("", true)
      ]);
    };
  }
});
...
const components = {
  [ChatMsgTypeText]: (extra, _, role) => {
    return createVNode(resolveComponent("text-message"), {
      "content": extra?.content,
      "role": role
    }, null);
  },
  [ChatMsgTypeCode]: (extra) => {
    return createVNode(resolveComponent("code-message"), {
      "lang": extra?.lang,
      "code": extra?.code
    }, null);
  },
  [ChatMsgTypeImage]: (extra) => {
    return createVNode(resolveComponent("image-message"), {
      "url": extra?.url
    }, null);
  },
  [ChatMsgTypeAudio]: (extra) => {
    return createVNode(resolveComponent("audio-message"), {
      "src": extra?.url
    }, null);
  },
  [ChatMsgTypeVideo]: (extra) => {
    return createVNode(resolveComponent("video-message"), {
      "url": extra?.url,
      "cover": extra?.cover,
  ...
  [ChatMsgTypeFile]: (extra, message) => {
    return createVNode(resolveComponent("file-message"), {
      "filename": extra?.name,
      "filesize": extra?.size,
  ...
  [ChatMsgTypeForward]: (extra) => {
    return createVNode(resolveComponent("forward-message"), {
      "count": extra?.msg_ids.length,
      "msg-ids": extra?.msg_ids,
      "talk-mode": extra?.talk_type,
      "items": extra.records.map((item) => {
        return {
  ...
  [ChatMsgTypeLogin]: (extra) => {
    return createVNode(resolveComponent("login-message"), {
  ...
  [ChatMsgTypeVote]: (extra) => {
    return createVNode(resolveComponent("vote-message"), {
  ...
  [ChatMsgTypeMixed]: (extra) => {
    ...
    return createVNode(resolveComponent("mixed-message"), {
      "items": items || []
    }, null);
  },
  [ChatMsgTypeGroupNotice]: (extra) => {
    return createVNode(resolveComponent("group-notice-message"), {
      "title": extra?.title,
      "content": extra?.content
    }, null);
  },
  [ChatMsgSysText]: (extra) => {
    return createVNode(resolveComponent("sys-text-message"), {
      "content": extra?.content
    }, null);
  },
  [ChatMsgSysGroupCreate]: (extra) => {
    const tpl = "{0} 创建了群聊，并邀请了 {1} 加入";
    return createVNode(resolveComponent("sys-text-tpl-message"), {
...
function render(extra, message, role) {
  ...
  return components[msgType]?.(extra, message, role) || createVNode(resolveComponent("unknown-message"), {
    "msgType": msgType
  }, null);
}
