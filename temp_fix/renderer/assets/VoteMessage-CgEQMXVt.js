import {
  ...
  aa as Button,
  eA as ServGroupVoteDetail,
  eB as ServGroupVoteSubmit,
  W as _export_sfc
          ...
          createBaseVNode('div', _hoisted_2, [
            createBaseVNode('div', _hoisted_3, [
              createBaseVNode(
                'p',
                _hoisted_4,
                toDisplayString(unref(detail).answer_mode == 2 ? '[多选投票]' : '[单选投票]'),
                1
              ),
              createBaseVNode('p', null, toDisplayString(unref(detail).title), 1)
            ]),
            unref(detail).is_submit
              ? (openBlock(),
                createElementBlock(
                  Fragment,
                  { key: 0 },
                  [
                    createBaseVNode('div', _hoisted_5, [
                      ...
                      createElementBlock(
                        Fragment,
                        null,
                        renderList(unref(detail).answer_options, (option) => {
                          return (
                            openBlock(),
                            createElementBlock(
                              'div',
                              ...
                              [
                                createBaseVNode(
                                  'p',
                                  _hoisted_6,
                                  toDisplayString(option.key) +
                                    '、 ' +
                                    toDisplayString(option.value),
                                  1
                                ),
                                createBaseVNode(
                                  'p',
                                  _hoisted_7,
                                  toDisplayString(option.num) +
                                    ' 票 ' +
                                    toDisplayString(option.progress) +
                                    '%',
                                  1
                                ),
                    ...
                    createBaseVNode('div', _hoisted_9, [
                      createBaseVNode(
                        'p',
                        null,
                        '应参与人数：' + toDisplayString(unref(detail).answer_num) + ' 人',
                        1
                      ),
                      createBaseVNode(
                        'p',
                        null,
                        '实际参与人数：' + toDisplayString(unref(detail).answered_num) + ' 人',
                        1
                      )
                    ])
                  ],
                            ...
                            createElementBlock(
                              'div',
                              {
                                class: normalizeClass([
                                  'option',
                                  { radio: unref(detail).answer_mode == 1 }
                                ]),
                                key: option.key
                              },
                              [
                                createBaseVNode('p', _hoisted_11, [
                                  createVNode(
                                    _component_n_checkbox,
                                    {
                                      ...
                                      'onUpdate:checked': [
                                        ($event) => (option.is_checked = $event),
                                        ($event) => onCheckboxChange(option.is_checked, option)
                                      ]
                                    },
                                    null,
                                    8,
                                ...
                                createBaseVNode(
                                  'p',
                                  {
                                    class: 'text',
                                    onClick: ($event) =>
                                      onCheckboxChange(!option.is_checked, option)
                                  },
                                  toDisplayString(option.key) +
                                    '、' +
                                    toDisplayString(option.value),
                    ...
                    createBaseVNode('div', _hoisted_13, [
                      createVNode(
                        ...
                        },
                        {
                          default: withCtx(() => [
                            createTextVNode(
                              toDisplayString(unref(isCanSubmit) ? '立即投票' : '请选择进行投票'),
                              1
                            )
                          ]),
                          _: 1
