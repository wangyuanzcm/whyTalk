import {
  ...
  bj as useMemo,
  w as repeat,
  c3 as NFadeInExpandTransition,
  B as pxfy,
  bM as cNotM,
  c4 as fadeInHeightExpandTransition,
...
function useKeyboard({
  ...
  const pendingNodeKeyRef = treeSelectInjection
    ...
    : ref(mergedSelectedKeys.length ? mergedSelectedKeys[mergedSelectedKeys.length - 1] : null)
  function handleKeydown(e) {
    ...
    if (pendingNodeKey === null) {
      ...
      if (e.key === 'Enter') {
        ...
        enterBehavior =
          ((_a = props.overrideDefaultNodeClickBehavior) === null || _a === void 0
            ? void 0
            : _a.call(props, {
...
const TreeNode = defineComponent({
  ...
  setup(props) {
    ...
    function handleNodeClick(e) {
      ...
      ;(_b = (_a = resolvedNodePropsRef.value) === null || _a === void 0 ? void 0 : _a.onClick) ===
        null || _b === void 0
        ? void 0
        : _b.call(_a, e)
    }
...
`,
 ...
 `
    ...
    c('>', [cB('tree-node', [c('&:first-child', 'margin-top: 0;')])]),
 ...
 `
    ...
    cNotM('block-line', [
      cB('tree-node', [
        cNotM('disabled', [
          cB('tree-node-content', [c('&:hover', 'background: var(--n-node-color-hover);')]),
          cM('selectable', [
            cB('tree-node-content', [c('&:active', 'background: var(--n-node-color-pressed);')])
          ]),
          cM('pending', [
            cB(
              'tree-node-content',
 ...
 `
          ...
          cM('selected', [cB('tree-node-content', 'background: var(--n-node-color-active);')])
        ]),
        cM('selected', [cB('tree-node-content', 'background: var(--n-node-color-active);')])
      ])
    ]),
 ...
 `
          ...
          cM('selectable', [
            cNotM('selected', [c('&:active', 'background: var(--n-node-color-pressed);')])
          ]),
 ...
 `,
          [
            cB('icon', [iconSwitchTransitionNode]),
            cB(
              'base-loading',
              `
 ...
 `,
            ...
            cB('base-icon', [iconSwitchTransitionNode])
          ]
        ),
...
const __unplugin_components_5 = defineComponent({
  ...
  setup(props) {
    ...
    watch(expandedNonLoadingKeysRef, (value, prevValue) => {
      ...
      const viewportHeight = (virtualScroll ? virtualListInstRef.value.listElRef : selfElRef.value)
        .offsetHeight
    ...
    function handleCheck(node, checked) {
      ...
      const { checkedKeys, indeterminateKeys } = dataTreeMateRef.value[checkedAction](
        node.key,
    ...
    function handleDragOver({ event, node }, emit = true) {
      ...
      if (
        ...
        (finalDropPosition === 'inside' &&
          ((_a = draggingNode.parent) === null || _a === void 0 ? void 0 : _a.key) ===
            finalDropNode.key)
      ) {
    ...
    const themeClassHandle = inlineThemeDisabled
      ? useThemeClass('tree', void 0, cssVarsRef, props)
      : void 0
        ...
        createElementBlock('section', _hoisted_1, [
              ...
              createVNode(_component_n_breadcrumb, null, {
                default: withCtx(() => [
                  ...
                  createElementBlock(
                    Fragment,
                    null,
                    renderList(unref(breadcrumb), (item) => {
                      return (
                        openBlock(),
                        createBlock(
                          _component_n_breadcrumb_item,
                          {
                            clickable: false,
                            key: item.name
                          },
          ...
          createBaseVNode('main', _hoisted_3, [
            createBaseVNode('section', _hoisted_4, [
              withDirectives(
                (openBlock(),
                createElementBlock('aside', _hoisted_5, [
                  createVNode(
                    _component_n_tree,
                    {
                      'key-field': 'dept_id',
              ...
              unref(filter).length
                ? (openBlock(),
                  createElementBlock('main', _hoisted_6, [
                    createVNode(
                                ...
                                [
                                  createBaseVNode('div', _hoisted_9, [
                                    ...
                                    createElementBlock(
                                      Fragment,
                                      null,
                                      renderList(item.position_items, (v, index) => {
                                        return (
                                          openBlock(),
                                          createBlock(
                                            unref(NTag),
                              ...
                              createBaseVNode('div', _hoisted_11, [
                                createVNode(
                                  ...
                                  },
                                  {
                                    default: withCtx(
                                      () =>
                                        _cache[1] || (_cache[1] = [createTextVNode(' 发消息 ', -1)])
                                    ),
                                    _: 2,
                                    __: [1]
                                  },
                ...
                : (openBlock(),
                  createElementBlock('main', _hoisted_12, [
