import { I as IconWrapper, H as createVNode, t as defineComponent, a1 as ref, a5 as createBlock, a6 as __unplugin_components_3, O as unref, ad as isRef, T as withCtx, U as openBlock, M as createBaseVNode, V as createTextVNode, aa as Button, dd as ServGroupApplyCreate, a4 as reactive, L as createElementBlock, a8 as createCommentVNode, R as toDisplayString, P as withDirectives, F as Fragment, a9 as renderList, Q as vShow, N as NIcon, de as ServGroupOvertList, W as _export_sfc } from "./index-CP-MMhae.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_n_modal, {
        show: unref(isShow),
        "onUpdate:show": _cache[1] || (_cache[1] = ($event) => isRef(isShow) ? isShow.value = $event : null),
        preset: "card",
        title: "入群申请",
        class: "modal-radius",
              ...
              createVNode(_component_n_form_item, {
                ...
                default: withCtx(() => [
                  createVNode(_component_n_input, {
                    ...
                    type: "textarea",
                    value: unref(remark),
                    "onUpdate:value": _cache[0] || (_cache[0] = ($event) => isRef(remark) ? remark.value = $event : null)
                  }, null, 8, ["value"])
                ]),
                _: 1
              })
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
          ...
          createBaseVNode("main", _hoisted_2, [
            createBaseVNode("section", _hoisted_3, [
              createBaseVNode("header", _hoisted_4, [
                createBaseVNode("div", null, "公开群聊(" + toDisplayString(unref(items).length) + ")", 1),
              ...
              unref(items).length == 0 ? (openBlock(), createElementBlock("main", _hoisted_5, [
                createBaseVNode("div", _hoisted_6, [
                  createVNode(_component_n_empty, { description: "暂无相关数据" })
                ])
              ])) : (openBlock(), createElementBlock("main", _hoisted_7, [
                createVNode(_component_n_alert, {
                  ...
                  default: withCtx(() => _cache[1] || (_cache[1] = [
                    createTextVNode(" 公开群聊可自行添加入群申请，待群主（管理员）同意后方可入群！ ", -1)
                  ])),
                  _: 1,
                  __: [1]
                }),
                createBaseVNode("div", _hoisted_8, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(items), (item) => {
                    ...
                    }, null, 8, ["avatar", "username", "gender", "motto", "flag", "onJoin"]);
                  }), 128)),
                  withDirectives(createBaseVNode("div", {
                    class: "flex-center more",
                    onClick: onLoadMore
                  }, [
                    createVNode(_component_n_icon, { component: unref(AddOne) }, null, 8, ["component"]),
        ...
        unref(model).isShow ? (openBlock(), createBlock(_sfc_main$1, {
          key: 0,
