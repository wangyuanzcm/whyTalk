  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("section", _hoisted_1, [
        _cache[9] || (_cache[9] = createBaseVNode("header", { class: "el-header box-header" }, "账号注册", -1)),
              ...
              createVNode(_component_n_form_item, {
                ...
                default: withCtx(() => [
                  createVNode(_component_n_input, {
                    ...
                    "onUpdate:value": _cache[2] || (_cache[2] = ($event) => unref(model).nickname = $event),
                    onKeydown: withKeys(onValidate, ["enter"])
                  }, null, 8, ["value"])
                ]),
                _: 1
              ...
              createVNode(_component_n_form_item, {
                ...
                default: withCtx(() => [
                  createVNode(_component_n_input, {
                    ...
                    "onUpdate:value": _cache[3] || (_cache[3] = ($event) => unref(model).password = $event),
                    onKeydown: withKeys(onValidate, ["enter"])
                  }, null, 8, ["value"])
                ]),
                _: 1
