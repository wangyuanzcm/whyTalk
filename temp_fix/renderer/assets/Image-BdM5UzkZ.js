import {
  ...
  b3 as resolveSlot,
  ey as isImageSupportNativeLazy,
  a2 as onMounted,
  bt as watchEffect,
  ez as observeIntersection,
  bk as provide
...
const RotateClockwiseIcon = replaceable('rotateClockwise', () =>
  h(
    'svg',
    {
      viewBox: '0 0 20 20',
...
const RotateCounterclockwiseIcon = replaceable('rotateClockwise', () =>
  h(
    'svg',
    {
      viewBox: '0 0 20 20',
...
const ZoomInIcon = replaceable('zoomIn', () =>
  h(
    'svg',
    {
      viewBox: '0 0 20 20',
...
const ZoomOutIcon = replaceable('zoomOut', () =>
  h(
    'svg',
    {
      viewBox: '0 0 20 20',
...
const NImagePreview = defineComponent({
  ...
  setup(props) {
    ...
    function getDerivedOffset(moveStrategy) {
      ...
      const { moveVerticalDirection, moveHorizontalDirection, deltaHorizontal, deltaVertical } =
        moveStrategy || {}
      let nextOffsetX = 0
      let nextOffsetY = 0
      if (pbox.width <= window.innerWidth) {
        ...
        nextOffsetX = Math.min(
          ...
          startOffsetX -
            (deltaHorizontal !== null && deltaHorizontal !== void 0 ? deltaHorizontal : 0)
        )
      } else {
      ...
      if (pbox.height <= window.innerHeight) {
        ...
        nextOffsetY = Math.min(
          ...
          startOffsetY - (deltaVertical !== null && deltaVertical !== void 0 ? deltaVertical : 0)
        )
      } else {
      ...
      ;(_b =
        (_a =
          imageContext === null || imageContext === void 0
            ? void 0
            : imageContext.previewedImgPropsRef.value) === null || _a === void 0
          ? void 0
    ...
    const cssVarsRef = computed(() => {
      const {
        ...
        self: { toolbarIconColor, toolbarBorderRadius, toolbarBoxShadow, toolbarColor }
      } = themeRef.value
      return {
                          ...
                          return h(
                            ...
                            renderToolbar
                              ...
                              : h(
                                  Fragment,
                                  null,
                                  this.onPrev ? h(Fragment, null, prevNode, nextNode) : null,
    ...
    return Object.assign(
      {
        ...
        mergedOnClick: (e) => {
          ...
          ;(_b = (_a = props.imgProps) === null || _a === void 0 ? void 0 : _a.onClick) === null ||
          _b === void 0
            ? void 0
            : _b.call(_a, e)
        },
