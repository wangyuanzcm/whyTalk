          ...
          createBaseVNode('div', _hoisted_1, [
            createBaseVNode('div', _hoisted_2, [
              createBaseVNode('div', _hoisted_3, [
                _cache[1] ||
                  (_cache[1] = createBaseVNode('div', { class: 'name' }, '主题颜色', -1)),
                createBaseVNode(
                  'div',
                  _hoisted_4,
                  '当前主题颜色 ：' + toDisplayString(unref(themeMode)),
                  1
                )
              ]),
                ...
                createVNode(
                  _component_n_radio_group,
                  {
                    ...
                    'onUpdate:value':
                      _cache[0] ||
                      (_cache[0] = ($event) =>
                        isRef(themeMode) ? (themeMode.value = $event) : null),
                    name: 'theme-group'
                  },
                  {
                    default: withCtx(() => [
            ...
            createBaseVNode('div', _hoisted_6, [
              ...
              createBaseVNode('div', _hoisted_7, [
                createVNode(
                  ...
                  {
                    default: withCtx(
                      () => _cache[2] || (_cache[2] = [createTextVNode(' 修改 ', -1)])
                    ),
                    _: 1,
                    __: [2]
                  }
            ...
            createBaseVNode('div', _hoisted_8, [
              ...
              createBaseVNode('div', _hoisted_9, [
                createVNode(
                  ...
                  {
                    default: withCtx(
                      () => _cache[4] || (_cache[4] = [createTextVNode(' 修改 ', -1)])
                    ),
                    _: 1,
                    __: [4]
                  }
