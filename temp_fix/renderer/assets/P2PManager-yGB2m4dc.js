import {
  ...
  b3 as resolveSlot,
  b4 as NBaseIcon,
  dt as paginationLight,
  b0 as createInjectionKey,
  c8 as depx,
  b9 as formatLength,
  ba as inject,
  du as useMergedClsPrefix,
  dv as ellipsisLight,
  dw as onDeactivated,
  v as mergeProps,
  dx as useStyle,
  dy as get$1,
  c2 as NIconSwitchTransition,
  bq as NBaseLoading,
  aW as Scrollbar,
  aa as Button,
  ...
  bj as useMemo,
  dz as cssrAnchorMetaName$1,
  a3 as onUnmounted,
  w as repeat,
  bT as warn,
  dA as configProviderInjectionKey,
  dB as insideModal,
  dC as insidePopover,
  c5 as iconSwitchTransition,
  bo as beforeNextFrameOnce,
  dD as dataTableLight,
  bk as provide,
  dE as createId,
  bl as flatten$1,
  bm as getSlot,
  dF as descriptionsLight,
  aX as getToken,
  dj as setToken,
  dG as deleteToken,
  b_ as useMessage,
  ...
  T as withCtx,
  O as unref,
  bw as __unplugin_components_2$3,
  a6 as __unplugin_components_3$2,
  U as openBlock,
  V as createTextVNode,
  M as createBaseVNode,
  a7 as __unplugin_components_1$2,
  dI as NText,
...
import {
  a as __unplugin_components_0,
  _ as __unplugin_components_2$1
...
import {
  ...
  _ as __unplugin_components_2$2
} from './Dropdown-BaOl703U.js'
import {
  N as NBaseSuffix,
  _ as __unplugin_components_1,
  C as ChevronDownIcon
} from './Input-9scKSWkl.js'
import { V as VVirtualList } from './VirtualList-B9WzfpoZ.js'
import { N as NEmpty } from './Empty-DXO3k6Nm.js'
import {
  u as useOnResize,
  N as NInternalSelectMenu,
  p as patternMatched,
  f as filterOptions,
  c as createTmOptions,
  a as createValOptMap,
  _ as __unplugin_components_2
} from './Popselect-t8R6dlXg.js'
...
import {
  ...
  _ as __unplugin_components_3$3
...
const VOverflow = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    function deriveCounter(options) {
      ...
      let counter
      if (getCounter !== void 0) counter = getCounter()
      else {
        counter = counterRef.value
      }
      if (!self2 || !counter) return
...
const style$5 = c$1([
 ...
 `,
    [
      c$1('&:last-child', 'padding-right: 0;'),
      cB(
        'tag',
        `
 font-size: 14px;
      ...
      default: () =>
        h(
          ...
          },
          {
            default: () => {
              var _a, _b
              return (_b = (_a = this.$slots).arrow) === null || _b === void 0
                ? void 0
                : _b.call(_a)
            }
          }
...
const NSelect = defineComponent({
  ...
  slots: Object,
  setup(props) {
    const { mergedClsPrefixRef, mergedBorderedRef, namespaceRef, inlineThemeDisabled } =
      useConfig(props)
    ...
    const valOptMapRef = computed(() =>
      createValOptMap(localOptionsRef.value, props.valueField, props.childrenField)
    )
    ...
    function handleTriggerBlur(e) {
      var _a, _b
      if (
        (_b = (_a = menuRef.value) === null || _a === void 0 ? void 0 : _a.selfRef) === null ||
        _b === void 0
          ? void 0
      ...
      switch (e.key) {
        ...
        case 'Enter':
          if (!((_a = triggerRef.value) === null || _a === void 0 ? void 0 : _a.isComposing)) {
            if (mergedShowRef.value) {
              const pendingTmNode =
                (_b = menuRef.value) === null || _b === void 0 ? void 0 : _b.getPendingTmNode()
              if (pendingTmNode) {
                      ...
                      return withDirectives(
                        h(
                          ...
                          Object.assign({}, this.menuProps, {
                            ...
                            style: [
                              (_c = this.menuProps) === null || _c === void 0 ? void 0 : _c.style,
                              this.cssVars
                            ],
                          ...
                          }),
                          {
                            empty: () => {
                              var _a2, _b2
                              return [
                                (_b2 = (_a2 = this.$slots).empty) === null || _b2 === void 0
                                  ? void 0
                                  : _b2.call(_a2)
                              ]
                            },
                            header: () => {
                              var _a2, _b2
                              return [
                                (_b2 = (_a2 = this.$slots).header) === null || _b2 === void 0
                                  ? void 0
                                  : _b2.call(_a2)
                              ]
                            },
                            action: () => {
                              var _a2, _b2
                              return [
                                (_b2 = (_a2 = this.$slots).action) === null || _b2 === void 0
                                  ? void 0
                                  : _b2.call(_a2)
                              ]
                            }
...
`,
 ...
 `
    ...
    c$1('&.transition-disabled', [cB('pagination-item', 'transition: none!important;')]),
    cB(
 ...
 `
        ...
        cNotM('disabled', [
          ...
          c$1('&:hover', hoverStyleProps, hoverStyleChildren),
          c$1(
            '&:active',
            `
...
function getDefaultPageSize(paginationProps2) {
  ...
  const { defaultPageSize } = paginationProps2
  if (defaultPageSize !== void 0) return defaultPageSize
  const pageSizeOption =
    (_a = paginationProps2.pageSizes) === null || _a === void 0 ? void 0 : _a[0]
  if (typeof pageSizeOption === 'number') return pageSizeOption
  return (
    (pageSizeOption === null || pageSizeOption === void 0 ? void 0 : pageSizeOption.value) || 10
  )
}
...
const NPagination = defineComponent({
  ...
  slots: Object,
  setup(props) {
    const { mergedComponentPropsRef, mergedClsPrefixRef, inlineThemeDisabled, mergedRtlRef } =
      useConfig(props)
    const themeRef = useTheme(
      'Pagination',
      '-pagination',
    ...
    const inputSizeRef = computed(() => {
      ...
      return (
        ((_b =
          ...
          ? void 0
          : _b.inputSize) || smallerSize(props.size)
      )
    })
      ...
      return (
        ((_b =
          (_a =
            ...
            : _a.Pagination) === null || _b === void 0
          ? void 0
          : _b.selectSize) || smallerSize(props.size)
      )
    })
                    ...
                    if (
                      ...
                      return h(
                        __unplugin_components_2,
                        {
                          ...
                          options:
                            pageItem.type !== 'page' && pageItem.options ? pageItem.options : [],
...
function shouldUseArrayInSingleMode(column) {
  return (
    ...
    (column.filterOptionValue === void 0 && column.defaultFilterOptionValues !== void 0)
  )
}
...
function generateCsv(columns, data, getCsvCell, getCsvHeader) {
  const exportableColumns = columns.filter(
    (column) =>
      column.type !== 'expand' && column.type !== 'selection' && column.allowExport !== false
  )
...
const RenderSafeRadio = defineComponent({
  ...
  setup(props) {
    const { mergedCheckedRowKeySetRef, componentId } = inject(dataTableInjectionKey)
    return () => {
      const { rowKey } = props
...
const NDataTableFilterMenu = defineComponent({
  ...
  setup(props) {
    const { mergedClsPrefixRef: mergedClsPrefixRefRtl, mergedRtlRef } = useConfig(props)
    const rtlEnabledRef = useRtl('DataTable', mergedRtlRef, mergedClsPrefixRefRtl)
    const { mergedClsPrefixRef, mergedThemeRef, localeRef } = inject(dataTableInjectionKey)
...
const SortButton = defineComponent({
  ...
  setup(props) {
    ...
    const sortStateRef = computed(() =>
      mergedSortStateRef.value.find((state) => state.columnKey === props.column.key)
    )
    const activeRef = computed(() => {
...
const SelectionMenu = defineComponent({
  ...
  setup(props) {
    ...
    const handleSelectRef = computed(() =>
      createSelectHandler(checkOptionsRef.value, rawPaginatedDataRef, doCheckAll, doUncheckAll)
    )
    ...
    return () => {
      ...
      return h(
        __unplugin_components_2$2,
        {
          theme:
            (_b = (_a = dataTableProps2.theme) === null || _a === void 0 ? void 0 : _a.peers) ===
              null || _b === void 0
              ? void 0
              : _b.Dropdown,
          themeOverrides:
            (_d =
              (_c = dataTableProps2.themeOverrides) === null || _c === void 0
                ? void 0
...
const TableHeader = defineComponent({
  ...
  setup() {
    ...
    function handleColHeaderClick(e, column) {
      ...
      const activeSorter =
        mergedSortStateRef.value.find((state) => state.columnKey === column.key) || null
  ...
  render() {
    ...
    const renderRow = (row, getLeft, headerHeightPx) =>
          ...
          CellComponent,
          {
            ...
            style: [
              getLeft && !column.fixed
                ...
                : {
                    left: pxfy(
                      (_a = fixedColumnLeftMap[key]) === null || _a === void 0 ? void 0 : _a.start
                    ),
                    right: pxfy(
                      (_b = fixedColumnRightMap[key]) === null || _b === void 0 ? void 0 : _b.start
                    )
                  },
              {
            ...
            onClick:
              column.type !== 'selection' && column.type !== 'expand' && !('children' in column)
                ? (e) => {
      ...
      style2.mount({
        ...
        parent:
          NConfigProvider === null || NConfigProvider === void 0
            ? void 0
            : NConfigProvider.styleMountTarget
      })
        ...
        default: () => {
          ...
          const renderRow = ({
            ...
            const virtualXRowHeight = isVirtualX
              ? pxfy(
                  (heightForRow === null || heightForRow === void 0
                    ? void 0
                    : heightForRow(rowData, actualRowIndex)) || minRowHeight
                )
              : void 0
            const cells = iteratedCols.map((col) => {
              ...
              const mergedColSpan = isSummary
                ? ((_a = rowInfo.tmNode.rawNode[colKey]) === null || _a === void 0
                    ? void 0
                    : _a.colSpan) || 1
                : colSpan
              ...
              const mergedRowSpan = isSummary
                ? ((_b = rowInfo.tmNode.rawNode[colKey]) === null || _b === void 0
                    ? void 0
                    : _b.rowSpan) || 1
                : rowSpan
                ...
                Object.assign({}, resolvedCellProps, {
                  ...
                  style: [
                    ...
                    isVirtualX && !column.fixed
                      ...
                      : {
                          left: pxfy(
                            (_c = fixedColumnLeftMap[colKey]) === null || _c === void 0
                              ? void 0
                              : _c.start
                          ),
                          right: pxfy(
                            (_d = fixedColumnRightMap[colKey]) === null || _d === void 0
                              ? void 0
                              : _d.start
                          )
                        },
            ...
            const row = h(
              ...
              Object.assign({}, props, {
                onMouseenter: (e) => {
                  ...
                  ;(_a = props === null || props === void 0 ? void 0 : props.onMouseenter) ===
                    null || _a === void 0
                    ? void 0
                    : _a.call(props, e)
                },
            ...
            return h(
              VVirtualList,
              {
                ...
                renderItemWithCols: virtualScrollX
                  ? ({ itemIndex, item, startColIndex, endColIndex, getLeft }) => {
                      return renderRow({
    ...
    function getHeaderElement() {
      ...
      if (value) {
        if (virtualScrollHeaderRef.value) {
          return (
            ((_a = value.virtualListRef) === null || _a === void 0 ? void 0 : _a.listElRef) || null
          )
        } else {
          return value.$el
        }
...
const style$1 = c$1([
 ...
 `
          ...
          cNotM('summary', [
            c$1('&:hover', 'background-color: var(--n-merged-td-color-hover);', [
 ...
 `
      ...
      cB('data-table-base-table', [
        cM('transition-disabled', [
          cB('data-table-th', [c$1('&::after, &::before', 'transition: none;')]),
          cB('data-table-td', [c$1('&::after, &::before', 'transition: none;')])
        ])
      ]),
      cM('bottom-bordered', [
        cB('data-table-td', [
...
function useCheck(props, data) {
  ...
  const mergedCheckState = computed(() => {
    ...
    const sourceKeys =
      checkedRowKeys === void 0 ? uncontrolledCheckedRowKeysRef.value : checkedRowKeys
    if (
      ((_a = selectionColumnRef.value) === null || _a === void 0 ? void 0 : _a.multiple) === false
    ) {
      return {
  ...
  const allRowsCheckedRef = computed(() => {
    ...
    return (
      countOfCurrentPageCheckedRowsRef.value !== 0 &&
      countOfCurrentPageCheckedRowsRef.value === length - countOfCurrentPageDisabledRowsRef.value
    )
  })
      ...
      ? (renderExpandRef === null || renderExpandRef === void 0 ? void 0 : renderExpandRef.value)
        ? (() => {
            ...
            treeMateRef.value.treeNodes.forEach((tmNode) => {
              var _a
              if (
                (_a = expandableRef.value) === null || _a === void 0
                  ? void 0
      ...
      if ('children' in column) {
        ...
        cols.push({
          ...
          style: createCustomWidthStyle(
            column,
            key !== void 0 ? formatLength(getResizableWidth(key)) : void 0
          ),
          column,
    ...
    columns2.forEach((column) => {
      ...
      if ('children' in column) {
        ...
        column.children.forEach((childColumn) => {
          ...
          rowItem.colSpan +=
            (_b =
              (_a2 = rowItemMap.get(childColumn)) === null || _a2 === void 0
                ? void 0
...
function useScroll(props, { mainTableInstRef, mergedCurrentPageRef, bodyWidthRef }) {
  ...
  function deriveActiveLeftFixedColumn() {
    ...
    for (let i = 0; i < leftFixedColumns.length; ++i) {
      ...
      if (
        lastScrollLeft >
        (((_a = fixedColumnLeftMap[key]) === null || _a === void 0 ? void 0 : _a.start) || 0) -
          leftWidth
      ) {
        leftActiveFixedColKey = key
        leftWidth =
          ((_b = fixedColumnLeftMap[key]) === null || _b === void 0 ? void 0 : _b.end) || 0
      } else {
        break
      }
    }
  ...
  function deriveActiveRightFixedColumn() {
    ...
    for (let i = rightFixedColumns.length - 1; i >= 0; --i) {
      ...
      if (
        ...
        rightWidth =
          ((_b = fixedColumnRightMap[key]) === null || _b === void 0 ? void 0 : _b.end) || 0
      } else {
        break
      }
    }
...
function useSorter(props, { dataRelatedColsRef, filteredDataRef }) {
  ...
  function sort(columnKey, order = 'ascend') {
    if (!columnKey) {
      ...
      const columnToSort = dataRelatedColsRef.value.find(
        (column) =>
          column.type !== 'selection' && column.type !== 'expand' && column.key === columnKey
      )
  ...
  function updateSortStatesByNewSortState(sortStates, sortState) {
    const index = sortStates.findIndex(
      (state) =>
        (sortState === null || sortState === void 0 ? void 0 : sortState.columnKey) &&
...
function useTableData(props, { dataRelatedColsRef }) {
  ...
  const treeMateRef = computed(() => {
    ...
    return createTreeMate(props.data, {
      ...
      getDisabled: (rowData) => {
        ...
        if (
          (_b =
            (_a = selectionColumnRef.value) === null || _a === void 0 ? void 0 : _a.disabled) ===
            null || _b === void 0
            ? void 0
            : _b.call(_a, rowData)
        ) {
    ...
    return data
      ? data.filter((tmNode) => {
          ...
          for (const [columnKey, column] of columnEntries) {
            ...
            const filter22 =
              column.filter === 'default' ? createDefaultFilter(columnKey) : column.filter
            if (column && typeof filter22 === 'function') {
              if (column.filterMode === 'and') {
                if (
                  activeFilterOptionValues.some(
                    (filterOptionValue) => !filter22(filterOptionValue, row)
                  )
                ) {
                  return false
                }
                ...
                if (
                  activeFilterOptionValues.some((filterOptionValue) =>
                    filter22(filterOptionValue, row)
                  )
                ) {
                  continue
                } else {
  ...
  const { sortedDataRef, deriveNextSorter, mergedSortStateRef, sort, clearSorter } = useSorter(
    props,
    {
      dataRelatedColsRef,
      filteredDataRef
  ...
  const controlledCurrentPageRef = computed(() => {
    const { pagination: pagination2 } = props
  ...
  const boundedMergedCurrentPageRef = useMemo(() => {
    ...
    return props.remote
      ...
      : Math.max(
          1,
          Math.min(Math.ceil(filteredDataRef.value.length / mergedPageSizeRef.value), page2)
        )
  })
  const mergedPageCountRef = computed(() => {
    const { pagination: pagination2 } = props
    if (pagination2) {
      const { pageCount } = pagination2
  ...
  function mergedOnUpdatePage(page2) {
    const { pagination: pagination2 } = props
    if (pagination2) {
      const { onChange, 'onUpdate:page': _onUpdatePage, onUpdatePage } = pagination2
  ...
  function onUnstableColumnResize(resizedWidth, limitedWidth, column, getColumnWidth) {
    ...
    ;(_a = props.onUnstableColumnResize) === null || _a === void 0
      ? void 0
      : _a.call(props, resizedWidth, limitedWidth, column, getColumnWidth)
  }
  function page(page2) {
    doUpdatePage(page2)
  }
...
const NDataTable = defineComponent({
  ...
  slots: Object,
  setup(props, { slots }) {
    const { mergedBorderedRef, mergedClsPrefixRef, inlineThemeDisabled, mergedRtlRef } =
      useConfig(props)
    ...
    const { rowsRef, colsRef, dataRelatedColsRef, hasEllipsisRef } = useGroupHeader(
      props,
      getResizableWidth
    )
    const {
    ...
    const contactColumns = [
      {
        ...
        key: 'peerId',
        render: (row) =>
          h('span', { style: 'font-family: monospace; font-size: 12px;' }, row.peerId)
      },
      {
        title: '昵称',
        key: 'nickname'
    ...
    return (_ctx, _cache) => {
      return (
        ...
        createElementBlock('div', _hoisted_1, [
          !status.value.isRunning
            ? (openBlock(),
              createBlock(
                ...
                {
                  header: withCtx(
                    () => _cache[13] || (_cache[13] = [createTextVNode('P2P 服务未启用', -1)])
                  ),
                  default: withCtx(() => [
                    _cache[14] ||
                      (_cache[14] = createTextVNode(
                        ' P2P 功能当前处于开发阶段，服务暂时未启用。这是一个演示界面，展示了 P2P 功能的完整设计。 ',
                        -1
                      )),
                    _cache[15] || (_cache[15] = createBaseVNode('br', null, null, -1)),
                    _cache[16] ||
                      (_cache[16] = createTextVNode(
                        '要启用 P2P 功能，需要解决 libp2p 依赖问题并重新启动服务。 ',
                        -1
                      ))
                  ]),
                  _: 1,
          ...
          createVNode(
            unref(__unplugin_components_2$3),
            {
              title: 'P2P 网络管理',
              class: 'mb-4'
            },
            {
              'header-extra': withCtx(() => [
                createVNode(
                  ...
                  },
                  {
                    default: withCtx(() => [
                      createTextVNode(
                        toDisplayString(status.value.isRunning ? '运行中' : '已停止'),
                        1
                      )
                    ]),
                    _: 1
              ...
              default: withCtx(() => [
                createVNode(
                  unref(__unplugin_components_1$2),
                  { vertical: '' },
                  {
                    default: withCtx(() => [
                      createVNode(
                                ...
                                default: withCtx(() => [
                                  createVNode(
                                    ...
                                    { code: '' },
                                    {
                                      default: withCtx(() => [
                                        createTextVNode(
                                          toDisplayString(status.value.peerId || '未知'),
                                          1
                                        )
                                      ]),
                                      _: 1
                        ...
                        default: withCtx(() => [
                          createVNode(
                            ...
                            },
                            {
                              default: withCtx(
                                () =>
                                  _cache[17] || (_cache[17] = [createTextVNode(' 刷新状态 ', -1)])
                              ),
                              _: 1,
                              __: [17]
                            },
                          ...
                          createVNode(
                            ...
                            },
                            {
                              default: withCtx(
                                () =>
                                  _cache[18] || (_cache[18] = [createTextVNode(' 刷新节点 ', -1)])
                              ),
                              _: 1,
                              __: [18]
                            },
          ...
          createVNode(
            unref(__unplugin_components_3$1),
            {
              'default-value': 'peers',
              type: 'line'
            },
                            ...
                            { justify: 'space-between' },
                            {
                              default: withCtx(() => [
                                createBaseVNode(
                                  'span',
                                  null,
                                  '已发现的节点 (' + toDisplayString(peers.value.length) + ')',
                                  1
                                ),
                                createVNode(
                                  unref(Button),
                                  ...
                                  },
                                  {
                                    default: withCtx(
                                      () =>
                                        _cache[19] || (_cache[19] = [createTextVNode(' 刷新 ', -1)])
                                    ),
                                    _: 1,
                                    __: [19]
                                  },
                            ...
                            { justify: 'space-between' },
                            {
                              default: withCtx(() => [
                                createBaseVNode(
                                  'span',
                                  null,
                                  'P2P联系人 (' + toDisplayString(contacts.value.length) + ')',
                                  1
                                ),
                                createVNode(unref(__unplugin_components_1$2), null, {
                                  default: withCtx(() => [
                                    createVNode(
                                      ...
                                      },
                                      {
                                        default: withCtx(
                                          () =>
                                            _cache[20] ||
                                            (_cache[20] = [createTextVNode(' 添加联系人 ', -1)])
                                        ),
                                        _: 1,
                                        __: [20]
                                      }
                                    ...
                                    createVNode(
                                      ...
                                      },
                                      {
                                        default: withCtx(
                                          () =>
                                            _cache[21] ||
                                            (_cache[21] = [createTextVNode(' 刷新 ', -1)])
                                        ),
                                        _: 1,
                                        __: [21]
                                      },
                        ...
                        header: withCtx(() => [
                          createVNode(
                            ...
                            { justify: 'space-between' },
                            {
                              default: withCtx(() => [
                                _cache[23] ||
                                  (_cache[23] = createBaseVNode('span', null, 'P2P群组', -1)),
                                createVNode(
                                  unref(Button),
                                  {
                                    size: 'small',
                                    onClick:
                                      _cache[1] ||
                                      (_cache[1] = ($event) => (showCreateGroupModal.value = true))
                                  },
                                  {
                                    default: withCtx(
                                      () =>
                                        _cache[22] ||
                                        (_cache[22] = [createTextVNode(' 创建群组 ', -1)])
                                    ),
                                    _: 1,
                                    __: [22]
                                  }
                              ...
                              default: withCtx(() => [
                                createVNode(
                                  ...
                                  },
                                  {
                                    default: withCtx(() => [
                                      createVNode(
                                        unref(__unplugin_components_3$3),
                                        { label: '接收方' },
                                        {
                                          default: withCtx(() => [
                                            createVNode(
                                              unref(NSelect),
                                              {
                                                ...
                                                'onUpdate:value':
                                                  _cache[2] ||
                                                  (_cache[2] = ($event) =>
                                                    (messageForm.value.targetPeerId = $event)),
                                      ...
                                      createVNode(
                                        ...
                                        { label: '消息内容' },
                                        {
                                          default: withCtx(() => [
                                            createVNode(
                                              unref(__unplugin_components_1),
                                              {
                                                value: messageForm.value.content,
                                                'onUpdate:value':
                                                  _cache[3] ||
                                                  (_cache[3] = ($event) =>
                                                    (messageForm.value.content = $event)),
                                                type: 'textarea',
                                                placeholder: '输入消息内容',
                                                rows: 3
                                              },
                                          ...
                                          createVNode(
                                            ...
                                            },
                                            {
                                              default: withCtx(
                                                () =>
                                                  _cache[24] ||
                                                  (_cache[24] = [createTextVNode(' 发送消息 ', -1)])
                                              ),
                                              _: 1,
                                              __: [24]
                                            },
          ...
          createVNode(
            unref(__unplugin_components_3$2),
            {
              show: showAddContactModal.value,
              'onUpdate:show':
                _cache[8] || (_cache[8] = ($event) => (showAddContactModal.value = $event)),
              preset: 'dialog',
              title: '添加P2P联系人'
            },
            {
                ...
                createVNode(unref(__unplugin_components_1$2), null, {
                  default: withCtx(() => [
                    createVNode(
                      ...
                      {
                        onClick:
                          _cache[7] || (_cache[7] = ($event) => (showAddContactModal.value = false))
                      },
                      {
                        default: withCtx(
                          () => _cache[25] || (_cache[25] = [createTextVNode('取消', -1)])
                        ),
                        _: 1,
                        __: [25]
                      }
                    ...
                    createVNode(
                      ...
                      {
                        default: withCtx(
                          () => _cache[26] || (_cache[26] = [createTextVNode('添加', -1)])
                        ),
                        _: 1,
                        __: [26]
                      },
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(__unplugin_components_1),
                              {
                                ...
                                'onUpdate:value':
                                  _cache[4] ||
                                  (_cache[4] = ($event) => (contactForm.value.peerId = $event)),
                                placeholder: '输入节点ID'
                              },
                              null,
                              8,
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(__unplugin_components_1),
                              {
                                ...
                                'onUpdate:value':
                                  _cache[5] ||
                                  (_cache[5] = ($event) => (contactForm.value.nickname = $event)),
                                placeholder: '输入昵称'
                              },
                              null,
                              8,
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(__unplugin_components_1),
                              {
                                ...
                                'onUpdate:value':
                                  _cache[6] ||
                                  (_cache[6] = ($event) => (contactForm.value.remark = $event)),
                                placeholder: '输入备注'
                              },
                              null,
                              8,
          ...
          createVNode(
            unref(__unplugin_components_3$2),
            {
              ...
              'onUpdate:show':
                _cache[12] || (_cache[12] = ($event) => (showCreateGroupModal.value = $event)),
              preset: 'dialog',
              title: '创建P2P群组'
            },
            {
                  ...
                  default: withCtx(() => [
                    createVNode(
                      unref(Button),
                      {
                        onClick:
                          _cache[11] ||
                          (_cache[11] = ($event) => (showCreateGroupModal.value = false))
                      },
                      {
                        default: withCtx(
                          () => _cache[27] || (_cache[27] = [createTextVNode('取消', -1)])
                        ),
                        _: 1,
                        __: [27]
                      }
                    ...
                    createVNode(
                      ...
                      {
                        default: withCtx(
                          () => _cache[28] || (_cache[28] = [createTextVNode('创建', -1)])
                        ),
                        _: 1,
                        __: [28]
                      },
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(__unplugin_components_1),
                              {
                                ...
                                'onUpdate:value':
                                  _cache[9] ||
                                  (_cache[9] = ($event) => (groupForm.value.name = $event)),
                                placeholder: '输入群组名称'
                              },
                              null,
                              8,
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(__unplugin_components_1),
                              {
                                ...
                                'onUpdate:value':
                                  _cache[10] ||
                                  (_cache[10] = ($event) => (groupForm.value.description = $event)),
                                type: 'textarea',
                                placeholder: '输入群组描述',
                                rows: 3
                              },
