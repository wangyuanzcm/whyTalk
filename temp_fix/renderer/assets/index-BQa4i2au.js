  ...
  return (
    ...
    createElementBlock(
      ...
      _cache[0] ||
        (_cache[0] = [
          createStaticVNode(
            '<div class="ant-spin ant-spin-lg ant-spin-spinning" data-v-e4a49ed6><span class="ant-spin-dot ant-spin-dot-spin" data-v-e4a49ed6><i class="ant-spin-dot-item" data-v-e4a49ed6></i><i class="ant-spin-dot-item" data-v-e4a49ed6></i><i class="ant-spin-dot-item" data-v-e4a49ed6></i><i class="ant-spin-dot-item" data-v-e4a49ed6></i></span></div><p data-v-e4a49ed6>数据加载中...</p>',
            2
          )
        ])
    )
...
const Loading = /* @__PURE__ */ _export_sfc(_sfc_main$7, [
  ['render', _sfc_render$1],
  ['__scopeId', 'data-v-e4a49ed6']
])
      ...
      return (
        ...
        createBlock(
          _component_n_modal,
          {
            ...
            'onUpdate:show':
              _cache[2] ||
              (_cache[2] = ($event) => (isRef(isShow) ? (isShow.value = $event) : null)),
            preset: 'card',
            title: '回收站管理',
            class: 'modal-radius',
                ...
                unref(tabIndex) == 1
                    ...
                    createElementBlock(
                      'main',
                      {
                        ...
                        class: normalizeClass([
                          'el-main me-scrollbar me-scrollbar-thumb',
                          {
                      ...
                      [
                        unref(state).note.loading
                          ? (openBlock(), createBlock(Loading, { key: 0 }))
                          : unref(state).note.items.length === 0
                            ? (openBlock(),
                            ...
                            : (openBlock(true),
                              createElementBlock(
                                Fragment,
                                { key: 2 },
                                renderList(unref(state).note.items, (note, index) => {
                                  return (
                                    openBlock(),
                                    createElementBlock(
                                      'div',
                                            ...
                                            createBaseVNode('div', _hoisted_10$3, [
                                              createVNode(
                                                _component_n_icon,
                                                {
                                                  ...
                                                  onClick: ($event) =>
                                                    onRecoverArticle(index, note.article_id)
                                                },
                                                null,
                                                8,
                                                ['component', 'onClick']
                                              ...
                                              createVNode(
                                                _component_n_icon,
                                                {
                                                  ...
                                                  onClick: ($event) =>
                                                    onDeleteArticle(index, note.article_id)
                                                },
                                                null,
                                                8,
                                                ['component', 'onClick']
                                          ...
                                          createBaseVNode('div', _hoisted_12$2, [
                                            createBaseVNode('div', _hoisted_13$1, [
                                              createBaseVNode(
                                                'span',
                                                null,
                                                toDisplayString(note.created_at.substr(0, 10)),
                                                1
                                              ),
                                              createBaseVNode(
                                                'span',
                                                null,
                                                toDisplayString(note.classify_name),
                                                1
                                              )
                                            ]),
                                            createBaseVNode(
                  ...
                  : (openBlock(),
                    createElementBlock(
                      ...
                      [
                        unref(state).annex.loading
                          ? (openBlock(), createBlock(Loading, { key: 0 }))
                          : unref(state).annex.items.length == 0
                            ? (openBlock(),
                              createBlock(_component_n_empty, {
                                key: 1,
                                description: '暂无相关数据'
                            ...
                            : (openBlock(true),
                              createElementBlock(
                                Fragment,
                                { key: 2 },
                                renderList(unref(state).annex.items, (annex, index) => {
                                  return (
                                    openBlock(),
                                    createElementBlock(
                                      'div',
                                        ...
                                        createBaseVNode('div', _hoisted_16, [
                                          createBaseVNode('div', _hoisted_17, [
                                            createBaseVNode(
                                              'span',
                                              _hoisted_18,
                                              toDisplayString(annex.annex_name),
                                              1
                                            )
                                          ]),
                                          createBaseVNode('div', _hoisted_19, [
                                            createBaseVNode(
                                              'div',
                                              _hoisted_20,
                                              '剩余' + toDisplayString(annex.day) + '天',
                                              1
                                            ),
                                            createBaseVNode('div', _hoisted_21, [
                                              createVNode(
                                                _component_n_icon,
                                                {
                                                  ...
                                                  onClick: ($event) =>
                                                    unref(ServeDownloadAnnex)(annex.annex_id)
                                                },
                                                null,
                                                8,
                                                ['component', 'onClick']
                                              ...
                                              createVNode(
                                                _component_n_icon,
                                                {
                                                  ...
                                                  component: unref(Undo),
                                                  onClick: ($event) =>
                                                    onRecoverAnnex(index, annex.annex_id)
                                                },
                                                null,
                                                8,
                                                ['component', 'onClick']
                                              ...
                                              createVNode(
                                                _component_n_icon,
                                                {
                                                  ...
                                                  component: unref(IconDelete),
                                                  onClick: ($event) =>
                                                    onDeleteAnnex(index, annex.annex_id)
                                                },
                                                null,
                                                8,
                                                ['component', 'onClick']
                                        ...
                                        createBaseVNode('div', _hoisted_22, [
                                          createBaseVNode('div', _hoisted_23, [
                                            createBaseVNode(
                                              'div',
                                              _hoisted_24,
                                              '所属笔记： ' + toDisplayString(annex.article_title),
                                              1
                                            )
                                          ])
                                        ])
      ...
      return (
        ...
        createElementBlock(
          ...
          [
            createBaseVNode('section', _hoisted_1$5, [
              createBaseVNode('header', _hoisted_2$4, [
                createVNode(
                  ...
                  {
                    default: withCtx(
                      () => _cache[4] || (_cache[4] = [createTextVNode(' + 新建笔记 ', -1)])
                    ),
                    _: 1,
                    __: [4]
                  }
                ...
                createBaseVNode('span', null, [
                  createVNode(
                    _component_n_button,
                    {
                      ...
                      color: 'red',
                      onClick:
                        _cache[1] || (_cache[1] = ($event) => (isShowRecycleModal.value = true))
                    },
                    {
                      default: withCtx(
                        () => _cache[5] || (_cache[5] = [createTextVNode(' 回收站 ', -1)])
                      ),
                      _: 1,
                      __: [5]
                    }
                ...
                createVNode(_component_n_scrollbar, null, {
                  default: withCtx(() => [
                    ...
                    createElementBlock(
                      Fragment,
                      null,
                      renderList(unref(menus), (menu2, i) => {
                        return (
                          openBlock(),
                          createElementBlock(
                            'div',
                            ...
                            [
                              createBaseVNode(
                                'div',
                                {
                                  class: normalizeClass([
                                    'menu-level1 pointer',
                                    { actived: menu2.indexName == unref(activedMenu) }
                                  ]),
                                    ...
                                    menu2.isShowCount
                                      ? (openBlock(),
                                        createElementBlock(
                                          ...
                                          [
                                            createTextVNode(
                                              ' (' + toDisplayString(menu2.submenus.length) + ') ',
                                              1
                                            )
                                          ],
                                          64
                              ...
                              createElementBlock(
                                Fragment,
                                null,
                                renderList(menu2.submenus, (submenu, i2) => {
                                  return withDirectives(
                                    ...
                                    createElementBlock(
                                      'div',
                                      {
                                        ...
                                        class: normalizeClass([
                                          'menu-level2 pointer',
                                          { actived: submenu.indexName == unref(activedMenu) }
                                        ]),
                                      ...
                                      [
                                        submenu.isEdit
                                          ? (openBlock(),
                                            createElementBlock('p', _hoisted_7$3, [
                                              withDirectives(
                                                createBaseVNode(
                                                  'input',
                                                  {
                                                    ...
                                                    onBlur: ($event) =>
                                                      onEditNoteMenu($event, i, i2, submenu),
                                                    type: 'text'
                                                  },
                                                  null,
                                                  40,
            ...
            unref(isShowRecycleModal)
              ? (openBlock(),
                createBlock(RecycleModal, {
                  key: 0,
        ...
        createElementBlock(
          ...
          [
            createBaseVNode('section', _hoisted_1$4, [
              ...
              unref(loadStatus) == 0 || !unref(items).length
                ? (openBlock(),
                  createElementBlock('main', _hoisted_6$2, [
                    unref(loadStatus) == 0
                      ? (openBlock(), createBlock(Loading, { key: 0 }))
                      : (openBlock(),
                        createBlock(_component_n_empty, {
                ...
                : (openBlock(),
                  createElementBlock('main', _hoisted_7$2, [
                    createVNode(_component_n_scrollbar, null, {
                      default: withCtx(() => [
                        (openBlock(true),
                        createElementBlock(
                              ...
                              createElementBlock(
                                'div',
                                {
                                  class: normalizeClass([
                                    ...
                                    { active: unref(loadId) == note.article_id }
                                  ]),
                                  key: note.article_id,
                                  onClick: ($event) => onCatDetail(note),
                                  onContextmenu: withModifiers(
                                    ($event) => unref(onContextMenu)($event, note),
                                    ['prevent']
                                  )
                                },
                                [
                                    ...
                                    createBaseVNode('div', _hoisted_11$1, [
                                      createBaseVNode('div', _hoisted_12$1, [
                                        createBaseVNode(
                                          'span',
                                          null,
                                          toDisplayString(note.created_at.substring(0, 10)),
                                          1
                                        ),
                                        createBaseVNode(
                                          'span',
                                          null,
                                          toDisplayString(note.class_name),
                                          1
                                        )
                                      ]),
                                      createBaseVNode(
    ...
    const onDelete = (item) => {
      dialog.create({
        ...
        onPositiveClick: async () => {
          ...
          if (code != 200) return
          store.detail.annex_list = store.detail.annex_list.filter(
        ...
        createElementBlock('section', _hoisted_1$3, [
          createBaseVNode('div', _hoisted_2$2, [
            createBaseVNode(
              'span',
              null,
              '附件列表(' + toDisplayString(unref(detail).annex_list.length) + ')',
              1
            )
          ]),
          createBaseVNode('div', _hoisted_3$2, [
            createBaseVNode('div', _hoisted_4$2, [
              ...
              createElementBlock(
                Fragment,
                null,
                renderList(unref(detail).annex_list, (file) => {
                  return (
                    openBlock(),
                    createElementBlock(
                      'div',
                      ...
                      [
                        createBaseVNode(
                          'div',
                          _hoisted_6$1,
                          toDisplayString(unref(getFileNameSuffix)(file.annex_name)),
                          1
                        ),
                        createBaseVNode('div', _hoisted_7$1, [
                          ...
                          createBaseVNode('div', _hoisted_9, [
                            createBaseVNode(
                              'span',
                              _hoisted_10,
                              toDisplayString(unref(fileFormatSize)(file.annex_size)),
                              1
                            ),
                                  ...
                                  default: withCtx(() => [
                                    createVNode(
                                      _component_n_button,
                                      {
                                        ...
                                        text: '',
                                        onClick: ($event) =>
                                          unref(ServeDownloadAnnex)(file.annex_id)
                                      },
                                      {
                                        default: withCtx(
                                          () =>
                                            _cache[0] ||
                                            (_cache[0] = [createTextVNode(' 下载 ', -1)])
                                        ),
                                        _: 2,
                                        __: [0]
                                      },
            ...
            createBaseVNode('div', _hoisted_12, [
              ...
              createVNode(
                ...
                {
                  icon: withCtx(() => [
                    createVNode(_component_n_icon, { component: unref(UploadOne) }, null, 8, [
                      'component'
                    ])
                  ]),
                  default: withCtx(() => [
...
const AnnexUploadModal = /* @__PURE__ */ _export_sfc(_sfc_main$3, [
  ['__scopeId', 'data-v-cea936f0']
])
const toolbars = [
  'revoke',
  'next',
            ...
            withDirectives(
              ...
              createElementBlock('section', _hoisted_1$2, [
                createBaseVNode('header', _hoisted_2$1, [
                  !unref(detail).article_id
                    ? (openBlock(), createElementBlock('img', _hoisted_3$1))
                    : createCommentVNode('', true),
                  unref(detail).article_id && unref(isPreviewMode)
                    ? (openBlock(),
                      createBlock(
                        _component_n_icon,
                        {
                  ...
                  createBaseVNode(
                    ...
                    toDisplayString(unref(detail).title),
                    41,
                    _hoisted_4$1
                  ),
                  createVNode(
                ...
                unref(isPreviewMode)
                  ? (openBlock(),
                    createElementBlock('header', _hoisted_5, [
                      createBaseVNode('p', null, [
                        ...
                        createBaseVNode(
                          ...
                          null,
                          '更新于 ' +
                            toDisplayString(unref(detail).updated_at.substring(0, 16)) +
                            '分',
                          1
                        )
                      ]),
                      createBaseVNode('p', _hoisted_6, [
                        ...
                        createVNode(
                          _component_n_popselect,
                          {
                            ...
                            'onUpdate:value': [
                              _cache[1] ||
                                (_cache[1] = ($event) => (unref(detail).classify_id = $event)),
                          ...
                          },
                          {
                            default: withCtx(() => [
                              createBaseVNode(
                                'span',
                                null,
                                '分类 (' + toDisplayString(unref(detail).class_name) + ')',
                                1
                              )
                            ]),
                            _: 1
                          ...
                          },
                          {
                            trigger: withCtx(() => [
                              createBaseVNode(
                                'span',
                                null,
                                '附件 (' + toDisplayString(unref(detail).annex_list.length) + ')',
                                1
                              )
                            ]),
                            default: withCtx(() => [createVNode(AnnexUploadModal)]),
                            _: 1
                          }
                        )
                      ]),
                      createBaseVNode('p', null, [
                        ...
                        createBaseVNode(
                          'span',
                          null,
                          '字数 (' + toDisplayString(unref(editor).markdown.length) + ')',
                          1
                        )
                      ])
                    ]))
                    ...
                    ? (openBlock(),
                      createBlock(
                        unref(MdPreview),
                        {
                          ...
                          'onUpdate:modelValue':
                            _cache[2] ||
                            (_cache[2] = ($event) => (unref(editor).markdown = $event)),
                    ...
                    : (openBlock(),
                      createBlock(
                        unref(Editor),
                        {
                          ...
                          'onUpdate:modelValue':
                            _cache[3] ||
                            (_cache[3] = ($event) => (unref(editor).markdown = $event)),
                          ...
                          onOnSave:
                            _cache[4] || (_cache[4] = ($event) => unref(onSaveDebounce)(false)),
                          onOnUploadImg: unref(onUploadImage)
                        },
                        null,
                        8,
                        ['modelValue', 'toolbars', 'theme', 'onOnUploadImg']
                      ))
                ])
              ])),
...
const NoteEmpty = /* @__PURE__ */ _export_sfc(_sfc_main$1, [
  ['render', _sfc_render],
  ['__scopeId', 'data-v-f2652b08']
])
    ...
    return (_ctx, _cache) => {
      ...
      return (
        ...
        createElementBlock('section', _hoisted_1, [
          createBaseVNode('aside', _hoisted_2, [createVNode(NoteMenu)]),
          withDirectives(
            (openBlock(), createElementBlock('aside', _hoisted_3, [createVNode(NoteList)])),
            [[_directive_dropsize, { min: 200, max: 500, direction: 'right', key: 'note-list' }]]
          ),
          createBaseVNode('main', _hoisted_4, [
            (openBlock(),
            createBlock(resolveDynamicComponent(unref(currentLoadId) > 0 ? NoteView : NoteEmpty)))
          ])
        ])
      )
    }
