        ...
        createBlock(
          ...
          },
          {
            default: withCtx(() => [
              withDirectives(
                (openBlock(),
                createElementBlock('section', _hoisted_1$1, [
                  createVNode(
                    unref(ChatPlus),
                    {
        ...
        createElementBlock(
          ...
          [
            ...
            createElementBlock(
              Fragment,
              null,
              renderList(_ctx.items, (record, index) => {
                return (
                  openBlock(),
                  createElementBlock(
                    'div',
            ...
            createBaseVNode('div', _hoisted_2, [
              createBaseVNode(
                'span',
                null,
                '转发：聊天会话记录 (' + toDisplayString(_ctx.count) + '条)',
                1
              )
            ]),
            isShowRecord.value
...
export { ForwardMessage as default }
