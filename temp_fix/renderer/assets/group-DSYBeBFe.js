        ...
        createElementBlock(
          ...
          [
            createBaseVNode('section', _hoisted_1, [
                  ...
                  createVNode(
                    _component_n_tabs,
                    {
                      ...
                      'onUpdate:value':
                        _cache[0] ||
                        (_cache[0] = ($event) =>
                          isRef(tabIndex) ? (tabIndex.value = $event) : null)
                    },
                    {
                      default: withCtx(() => [
                        createVNode(
                          ...
                          { name: 'all' },
                          {
                            default: withCtx(() => [
                              createTextVNode(
                                ' 全部群聊(' + toDisplayString(unref(items).length) + ') ',
                                1
                              )
                            ]),
                            _: 1
                        ...
                        createVNode(
                          ...
                          { name: 'create' },
                          {
                            default: withCtx(() => [
                              createTextVNode(
                                ' 我创建的(' + toDisplayString(unref(filterCreator).length) + ') ',
                                1
                              )
                            ]),
                            _: 1
                          ...
                          { name: 'join' },
                          {
                            default: withCtx(() => [
                              createTextVNode(
                                ' 我加入的(' +
                                  toDisplayString(
                                    unref(items).length - unref(filterCreator).length
                                  ) +
                                  ') ',
                                1
                              )
                  ...
                  default: withCtx(() => [
                    ...
                    createVNode(
                      _component_n_button,
                      {
                        circle: '',
                        onClick:
                          _cache[2] || (_cache[2] = ($event) => (isShowCreateGroupBox.value = true))
                      },
                      {
                        icon: withCtx(() => [
              ...
              unref(filter).length == 0
                ? (openBlock(),
                  createElementBlock('main', _hoisted_3, [
                        ...
                        renderList(unref(filter), (item) => {
                          return (
                            ...
                            createBlock(
                              ...
                              null,
                              8,
                              ['avatar', 'username', 'gender', 'motto', 'onClick', 'onTalk']
                            )
                          )
                        }),
                        128
            ...
            unref(isShowCreateGroupBox)
              ? (openBlock(),
                createBlock(GroupLaunch, {
                  key: 0,
                  'group-id': 0,
                  onClose:
                    _cache[3] || (_cache[3] = ($event) => (isShowCreateGroupBox.value = false)),
            ...
            createVNode(
              _component_n_drawer,
              {
                ...
                'onUpdate:show':
                  _cache[6] || (_cache[6] = ($event) => (unref(params).isShow = $event)),
                width: 400,
                placement: 'right',
                'trap-focus': false,
                'block-scroll': false,
                ...
                default: withCtx(() => [
                  createVNode(
                    GroupPanel,
                    {
                      ...
                      onClose:
                        _cache[4] || (_cache[4] = ($event) => (unref(params).isShow = false)),
                      onToTalk:
                        _cache[5] ||
                        (_cache[5] = ($event) =>
                          unref(talkStore).toTalk(2, unref(params).group_id, unref(router)))
                    },
                    null,
                    8,
                    ['group-id']
