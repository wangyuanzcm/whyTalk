...
import { Y as getDefaultExportFromCjs, t as defineComponent, a1 as ref, L as createElementBlock, U as openBlock, H as createVNode, M as createBaseVNode, O as unref, N as NIcon, T as withCtx, bw as __unplugin_components_2, ad as isRef, a6 as __unplugin_components_3, d2 as normalizeStyle, bC as nextTick, W as _export_sfc } from "./index-CP-MMhae.js";
...
var PCPlugin = /* @__PURE__ */ function(_BasePlugin) {
  ...
  function PCPlugin2() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onVideoClick", function(e) {
      ...
      if (e.target === player.root || e.target === player.media || e.target === player.innerContainer || e.target === player.media.__canvas) {
        ...
        _this.clickTimer = setTimeout(function() {
          ...
          _this._clickCount--;
          runHooks(_assertThisInitialized(_this), HOOKS$1[0], function(plugin, data) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onVideoDblClick", function(e) {
      ...
      e.preventDefault();
      e.stopPropagation();
      runHooks(_assertThisInitialized(_this), HOOKS$1[1], function(plugin, data) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("section", {
        ...
        createVNode(_component_n_modal, {
          show: unref(open),
          "onUpdate:show": _cache[1] || (_cache[1] = ($event) => isRef(open) ? open.value = $event : null)
        }, {
          default: withCtx(() => [
            createVNode(_component_n_card, {
              ...
              default: withCtx(() => [
                _cache[2] || (_cache[2] = createBaseVNode("div", { id: "im-xgplayer" }, null, -1)),
                createBaseVNode("div", {
