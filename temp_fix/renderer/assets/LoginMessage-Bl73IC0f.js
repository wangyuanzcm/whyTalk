...
import { t as defineComponent, L as createElementBlock, U as openBlock, M as createBaseVNode, V as createTextVNode, R as toDisplayString, O as unref, W as _export_sfc } from "./index-CP-MMhae.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1, [
        ...
        createBaseVNode("p", null, [
          ...
          createTextVNode(toDisplayString(unref(getExploreName)(_ctx.agent)) + " / " + toDisplayString(unref(getExploreOs)(_ctx.agent)), 1)
        ]),
        createBaseVNode("p", null, [
