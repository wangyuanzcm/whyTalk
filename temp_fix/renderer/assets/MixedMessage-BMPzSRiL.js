...
import { t as defineComponent, L as createElementBlock, U as openBlock, M as createBaseVNode, V as createTextVNode, F as Fragment, a9 as renderList, a8 as createCommentVNode, O as unref, d2 as normalizeStyle, H as createVNode, W as _export_sfc } from "./index-CP-MMhae.js";
            ...
            return openBlock(), createElementBlock("span", {
              ...
              item.type === "text" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                ...
                createBaseVNode("span", {
                  innerHTML: unref(textReplaceEmoji)(unref(textReplaceLink)(item.content))
                }, null, 8, _hoisted_2),
                _cache[1] || (_cache[1] = createTextVNode("\n        ", -1))
              ], 64)) : item.type === "image" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                _cache[4] || (_cache[4] = createTextVNode("\n          ", -1)),
                createBaseVNode("div", {
                  style: normalizeStyle([img(item.content, 300), { "display": "flex", "margin": "3px 0", "border-radius": "3px", "overflow": "hidden" }])
                }, [
