    ...
    const togglePlugin = async (plugin2) => {
      ...
      try {
        const result = newEnabled
          ? await PluginAPI.enablePlugin(plugin2.id)
          : await PluginAPI.disablePlugin(plugin2.id)
        if (result.success) {
    ...
    return (_ctx, _cache) => {
      ...
      return (
        ...
        createElementBlock('section', null, [
            ...
            createVNode(unref(__unplugin_components_1), null, {
              default: withCtx(() => [
                createVNode(
                  ...
                  {
                    icon: withCtx(() => [createVNode(unref(Download))]),
                    default: withCtx(() => [
                ...
                createVNode(
                  ...
                  {
                    default: withCtx(
                      () => _cache[13] || (_cache[13] = [createTextVNode(' 刷新列表 ', -1)])
                    ),
                    _: 1,
                    __: [13]
                  },
            ...
            plugins.value.length > 0
              ? (openBlock(),
                createElementBlock('div', _hoisted_3, [
                  ...
                  createElementBlock(
                    Fragment,
                    null,
                    renderList(plugins.value, (plugin2) => {
                      return (
                        openBlock(),
                        createBlock(
                          unref(__unplugin_components_2),
                          {
                            key: plugin2.id,
                            class: 'plugin-card',
                            hoverable: ''
                            ...
                            header: withCtx(() => [
                              createBaseVNode('div', _hoisted_4, [
                                createBaseVNode(
                                  'span',
                                  _hoisted_5,
                                  toDisplayString(plugin2.config?.name || plugin2.id),
                                  1
                                ),
                                createVNode(
                                  unref(NTag),
                                  ...
                                  },
                                  {
                                    default: withCtx(() => [
                                      createTextVNode(
                                        toDisplayString(getStatusText(plugin2.enabled)),
                                        1
                                      )
                                    ]),
                                    _: 2
                                    ...
                                    plugin2.config?.ui?.settings
                                      ? (openBlock(),
                                        createBlock(
                                          ...
                                          {
                                            icon: withCtx(() => [createVNode(unref(Setting))]),
                                            default: withCtx(() => [
                                              _cache[14] ||
                                                (_cache[14] = createTextVNode(' 配置 ', -1))
                                            ]),
                                            _: 2,
                                            __: [14]
                                          },
                                        ...
                                        trigger: withCtx(() => [
                                          createVNode(
                                            ...
                                            },
                                            {
                                              ...
                                              default: withCtx(() => [
                                                _cache[15] ||
                                                  (_cache[15] = createTextVNode(' 卸载 ', -1))
                                              ]),
                                              _: 1,
                                              __: [15]
                                            }
                            ...
                            default: withCtx(() => [
                              createBaseVNode('div', _hoisted_6, [
                                createBaseVNode(
                                  'p',
                                  _hoisted_7,
                                  toDisplayString(plugin2.config?.description || '无描述'),
                                  1
                                ),
                                createBaseVNode('p', _hoisted_8, [
                                  createBaseVNode(
                                    'span',
                                    null,
                                    '版本: ' + toDisplayString(plugin2.config?.version || '未知'),
                                    1
                                  ),
                                  createBaseVNode(
                                    'span',
                                    null,
                                    '作者: ' + toDisplayString(plugin2.config?.author || '未知'),
                                    1
                                  )
                                ]),
                                createBaseVNode(
                                  'p',
                                  _hoisted_9,
                                  '类型: ' + toDisplayString(plugin2.type),
                                  1
                                )
                              ])
                            ]),
              ...
              : (openBlock(),
                createElementBlock(
                  'div',
                  _hoisted_10,
                  _cache[16] || (_cache[16] = [createBaseVNode('p', null, '暂无已安装的插件', -1)])
                ))
          ]),
          createBaseVNode('div', _hoisted_11, [
            ...
            createBaseVNode('div', _hoisted_12, [
              ...
              createElementBlock(
                Fragment,
                null,
                renderList(marketPlugins.value, (plugin2) => {
                  return (
                    openBlock(),
                    createBlock(
                      unref(__unplugin_components_2),
                        ...
                        default: withCtx(() => [
                          createBaseVNode('div', _hoisted_15, [
                            createBaseVNode(
                              'p',
                              _hoisted_16,
                              toDisplayString(plugin2.description),
                              1
                            ),
                            createBaseVNode('p', _hoisted_17, [
                              createBaseVNode(
                                'span',
                                null,
                                '版本: ' + toDisplayString(plugin2.version),
                                1
                              ),
                              createBaseVNode(
                                'span',
                                null,
                                '作者: ' + toDisplayString(plugin2.author),
                                1
                              )
                            ]),
                            createBaseVNode('p', _hoisted_18, [
                              createBaseVNode(
                                'span',
                                null,
                                '评分: ' + toDisplayString(plugin2.rating) + '/5',
                                1
                              ),
                              createBaseVNode(
                                'span',
                                null,
                                '下载: ' + toDisplayString(plugin2.downloads),
                                1
                              )
                            ])
                          ])
          ...
          createVNode(
            unref(__unplugin_components_3),
            {
              show: showUploadModal.value,
              'onUpdate:show':
                _cache[3] || (_cache[3] = ($event) => (showUploadModal.value = $event)),
              preset: 'dialog',
              title: '本地安装插件',
            ...
            },
            {
              default: withCtx(() => [
                createBaseVNode('div', _hoisted_19, [
                  !uploadLoading.value && !installResult.value
                    ? (openBlock(),
                      createElementBlock('div', _hoisted_20, [
                        ...
                        createVNode(
                          ...
                          },
                          {
                            default: withCtx(
                              () =>
                                _cache[20] || (_cache[20] = [createTextVNode(' 选择插件文件 ', -1)])
                            ),
                            _: 1,
                            __: [20]
                          }
                      ...
                      createElementBlock('div', _hoisted_21, [
                        createBaseVNode('div', _hoisted_22, [
                          ...
                          createBaseVNode(
                            'span',
                            _hoisted_23,
                            toDisplayString(installStep.value),
                            1
                          )
                        ]),
                        createVNode(
                        ...
                        createBaseVNode(
                          'p',
                          {
                            class: normalizeClass([
                              'result-message',
                              {
                                success: installResult.value.success,
                                error: !installResult.value.success
                              }
                            ])
                          },
                          toDisplayString(installResult.value.message),
                          3
                        ),
                        installResult.value.success
                          ? (openBlock(),
                              ...
                              _cache[25] ||
                                (_cache[25] = [
                                  createBaseVNode(
                                    'p',
                                    null,
                                    '插件已成功安装到系统中，窗口将在几秒后自动关闭',
                                    -1
                                  )
                                ])
                            ))
                          : (openBlock(),
                            createElementBlock('div', _hoisted_29, [
                              createVNode(
                                unref(Button),
                                {
                                ...
                                },
                                {
                                  default: withCtx(
                                    () =>
                                      _cache[26] ||
                                      (_cache[26] = [createTextVNode(' 重新安装 ', -1)])
                                  ),
                                  _: 1,
                                  __: [26]
                                }
                              ...
                              createVNode(
                                ...
                                },
                                {
                                  default: withCtx(
                                    () =>
                                      _cache[27] || (_cache[27] = [createTextVNode(' 关闭 ', -1)])
                                  ),
                                  _: 1,
                                  __: [27]
                                }
          ...
          createVNode(
            unref(__unplugin_components_3),
            {
              ...
              'onUpdate:show':
                _cache[8] || (_cache[8] = ($event) => (showRemoteModal.value = $event)),
              preset: 'dialog',
              title: '远程安装插件'
            },
            {
                ...
                createVNode(unref(__unplugin_components_1), null, {
                  default: withCtx(() => [
                    createVNode(
                      ...
                      {
                        onClick:
                          _cache[7] || (_cache[7] = ($event) => (showRemoteModal.value = false))
                      },
                      {
                        default: withCtx(
                          () => _cache[28] || (_cache[28] = [createTextVNode('取消', -1)])
                        ),
                        _: 1,
                        __: [28]
                      }
                    ...
                    createVNode(
                      ...
                      {
                        default: withCtx(
                          () => _cache[29] || (_cache[29] = [createTextVNode(' 安装 ', -1)])
                        ),
                        _: 1,
                        __: [29]
                      },
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(__unplugin_components_1$1),
                              {
                                ...
                                'onUpdate:value':
                                  _cache[4] || (_cache[4] = ($event) => (remoteForm.url = $event)),
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(__unplugin_components_1$1),
                              {
                                ...
                                'onUpdate:value':
                                  _cache[5] || (_cache[5] = ($event) => (remoteForm.name = $event)),
                          ...
                          default: withCtx(() => [
                            createVNode(
                              unref(__unplugin_components_1$1),
                              {
                                ...
                                'onUpdate:value':
                                  _cache[6] ||
                                  (_cache[6] = ($event) => (remoteForm.description = $event)),
          ...
          createVNode(
            unref(__unplugin_components_3),
            {
              ...
              'onUpdate:show':
                _cache[10] || (_cache[10] = ($event) => (showConfigModal.value = $event)),
              preset: 'dialog',
              title: '插件配置'
            },
            {
                ...
                createVNode(unref(__unplugin_components_1), null, {
                  default: withCtx(() => [
                    createVNode(
                      ...
                      {
                        onClick:
                          _cache[9] || (_cache[9] = ($event) => (showConfigModal.value = false))
                      },
                      {
                        default: withCtx(
                          () => _cache[30] || (_cache[30] = [createTextVNode('取消', -1)])
                        ),
                        _: 1,
                        __: [30]
                      }
                    ...
                    createVNode(
                      ...
                      {
                        default: withCtx(
                          () => _cache[31] || (_cache[31] = [createTextVNode(' 保存配置 ', -1)])
                        ),
                        _: 1,
                        __: [31]
                      }
              ...
              default: withCtx(() => [
                currentPlugin.value
                  ? (openBlock(),
                    createElementBlock('div', _hoisted_30, [
                      createBaseVNode(
                        'h4',
                        null,
                        toDisplayString(
                          currentPlugin.value.config?.name || currentPlugin.value.id
                        ) + ' 配置',
                        1
                      ),
                      createVNode(
