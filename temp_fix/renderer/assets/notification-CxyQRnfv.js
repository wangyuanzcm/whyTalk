import { t as defineComponent, au as useSettingsStore, z as computed, a1 as ref, L as createElementBlock, M as createBaseVNode, R as toDisplayString, O as unref, H as createVNode, ad as isRef, V as createTextVNode, P as withDirectives, Q as vShow, T as withCtx, aa as Button, U as openBlock, W as _export_sfc } from "./index-CP-MMhae.js";
        ...
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("div", _hoisted_3, [
              _cache[3] || (_cache[3] = createBaseVNode("div", { class: "name" }, "新消息提示音", -1)),
              createBaseVNode("div", _hoisted_4, "新消息提示音 ：" + toDisplayString(unref(isPromptTone) ? "已开启" : "已关闭"), 1)
            ]),
            createBaseVNode("div", _hoisted_5, [
              createVNode(_component_n_switch, {
                size: "medium",
                value: unref(isPromptTone),
                "onUpdate:value": _cache[0] || (_cache[0] = ($event) => isRef(isPromptTone) ? isPromptTone.value = $event : null)
              }, null, 8, ["value"])
            ])
          ]),
          createBaseVNode("div", _hoisted_6, [
            createBaseVNode("div", _hoisted_7, [
              _cache[4] || (_cache[4] = createBaseVNode("div", { class: "name" }, "推送键盘输入消息", -1)),
              createBaseVNode("div", _hoisted_8, "推送键盘输入消息：" + toDisplayString(unref(isKeyboard) ? "已开启" : "已关闭"), 1)
            ]),
            createBaseVNode("div", _hoisted_9, [
              createVNode(_component_n_switch, {
                size: "medium",
                value: unref(isKeyboard),
                "onUpdate:value": _cache[1] || (_cache[1] = ($event) => isRef(isKeyboard) ? isKeyboard.value = $event : null)
              }, null, 8, ["value"])
            ])
          ]),
          createBaseVNode("div", _hoisted_10, [
            createBaseVNode("div", _hoisted_11, [
              _cache[8] || (_cache[8] = createBaseVNode("div", { class: "name" }, "消息通知", -1)),
              createBaseVNode("div", _hoisted_12, [
                createTextVNode(" 消息通知：" + toDisplayString(unref(isNotify) ? "已开启" : "已关闭") + " ", 1),
                withDirectives(createBaseVNode("span", null, [
                  _cache[6] || (_cache[6] = createTextVNode(" (当前未获得浏览器通知权限， ", -1)),
            ...
            createBaseVNode("div", _hoisted_13, [
              createVNode(_component_n_switch, {
                ...
                "onUpdate:value": _cache[2] || (_cache[2] = ($event) => isRef(isNotify) ? isNotify.value = $event : null)
              }, null, 8, ["value"])
            ])
          ])
        ])
