...
const ClearIcon = replaceable('clear', () =>
  h(
    'svg',
    {
      viewBox: '0 0 16 16',
                  ...
                  },
                  {
                    placeholder: () =>
                      h(
                        ...
                        {
                          default: () =>
                            resolveSlot(slots.default, () => [h(ChevronDownIcon, null)])
                        }
                      )
                  }
                )
...
`,
 ...
 `
      ...
      c('&:hover', [cE('state-border', 'border: var(--n-border-hover);')]),
...
const __unplugin_components_1 = defineComponent({
  ...
  slots: Object,
  setup(props) {
    const { mergedClsPrefixRef, mergedBorderedRef, inlineThemeDisabled, mergedRtlRef } =
      useConfig(props)
      ...
      if (props.type === 'textarea') {
        ...
        if (autosize) {
          textAreaScrollContainerWidthRef.value =
            (_b =
              (_a = textareaScrollbarInstRef.value) === null || _a === void 0 ? void 0 : _a.$el) ===
              null || _b === void 0
              ? void 0
              : _b.offsetWidth
        }
          ...
          : h(
              ...
              h(
                ...
                Object.assign(
                  {
                    type:
                      type === 'password' && this.mergedShowPasswordOn && this.passwordVisible
                        ? 'text'
                        : type
                  },
                  this.inputProps,
                      ...
                      return (
                        ...
                        h(
                          ...
                          },
                          {
                            ...
                            icon: () => {
                              var _a2, _b2
                              return (_b2 = (_a2 = this.$slots)['clear-icon']) === null ||
                                _b2 === void 0
                                ? void 0
                                : _b2.call(_a2)
                            }
                    ...
                    this.clearable &&
                      h(
                        ...
                        },
                        {
                          icon: () => {
                            var _a2
                            return (_a2 = $slots['clear-icon']) === null || _a2 === void 0
                              ? void 0
                              : _a2.call($slots)
                          },
                          placeholder: () => {
                            var _a2
                            return (_a2 = $slots['clear-icon-placeholder']) === null ||
                              _a2 === void 0
                              ? void 0
                              : _a2.call($slots)
                          }
...
export { ChevronDownIcon as C, NBaseSuffix as N, __unplugin_components_1 as _ }
