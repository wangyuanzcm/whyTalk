import {
  ...
  C as ContextTracker,
  t as tags,
  o as defineCSSCompletionSource,
  L as LRLanguage,
...
const spaces = new ExternalTokenizer(
  (input, stack) => {
...
const parser = LRParser.deserialize({
  ...
  specialized: [
    ...
    { term: 173, get: (value) => spec_queryIdentifier[value] || -1 }
  ],
  tokenPrec: 3217
})
...
const sassCompletionSource = /* @__PURE__ */ defineCSSCompletionSource(
  (node) => node.name == 'VariableName' || node.name == 'SassVariableName'
)
