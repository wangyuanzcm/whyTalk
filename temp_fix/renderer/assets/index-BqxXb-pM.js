...
function parseResponsivePropValue(reponsiveProp, activeKeyOrSize) {
  var _a
  if (reponsiveProp === void 0 || reponsiveProp === null) return void 0
  const classObj = parseResponsiveProp(reponsiveProp)
  if (activeKeyOrSize === void 0) return classObj['']
...
function isNodeVShowFalse(vNode) {
  var _a
  const showDir =
    (_a = vNode.dirs) === null || _a === void 0 ? void 0 : _a.find(({ dir }) => dir === vShow)
...
const NGrid = defineComponent({
  ...
  setup(props) {
    ...
    const responsiveColsRef = useMemo(() => {
      var _a
      return (_a = Number(
        parseResponsivePropValue(props.cols.toString(), responsiveQueryRef.value)
      )) !== null && _a !== void 0
        ? _a
        : defaultCols
    })
  ...
  render() {
    ...
    const renderContent = () => {
      ...
      rawChildren.forEach((child) => {
        ...
        if (
          ((_a2 = child === null || child === void 0 ? void 0 : child.type) === null ||
          _a2 === void 0
            ? void 0
        ...
        const rawChildSpan = Number(
          (_e2 = parseResponsivePropValue(
            (_d2 = clonedChild.props) === null || _d2 === void 0 ? void 0 : _d2.span,
            responsiveQuery
          )) !== null && _e2 !== void 0
            ? _e2
            : defaultSpan$1
      ...
      const maybeSuffixNode =
        (_a = childrenAndRawSpan[childrenAndRawSpan.length - 1]) === null || _a === void 0
          ? void 0
          : _a.child
      if (maybeSuffixNode === null || maybeSuffixNode === void 0 ? void 0 : maybeSuffixNode.props) {
        const suffixPropValue =
          (_b = maybeSuffixNode.props) === null || _b === void 0 ? void 0 : _b.suffix
        if (suffixPropValue !== void 0 && suffixPropValue !== false) {
          suffixSpan = Number(
            (_d = parseResponsivePropValue(
              (_c = maybeSuffixNode.props) === null || _c === void 0 ? void 0 : _c.span,
              responsiveQuery
            )) !== null && _d !== void 0
              ? _d
              : defaultSpan$1
  ...
  render() {
    ...
    const descriptionNode =
      ...
      h(
        ...
        description ||
          ((_a = $slots.description) === null || _a === void 0 ? void 0 : _a.call($slots))
      )
  ...
  setup(__props) {
    ...
    const loadPlugins = async () => {
      try {
        ...
        plugins.value = pluginList.filter(
          (plugin) => plugin.type === 'system' || plugin.type === 'frontend'
        )
      } catch (err) {
    ...
    const openPlugin = async (plugin) => {
      try {
        ...
        window.$message?.error(`打开插件失败: ${err instanceof Error ? err.message : String(err)}`)
      }
    }
              ...
              { show: loading.value },
              {
                default: withCtx(() => [
                  error.value
                            ...
                            extra: withCtx(() => [
                              ...
                              createVNode(
                                ...
                                },
                                {
                                  default: withCtx(
                                    () =>
                                      _cache[2] || (_cache[2] = [createTextVNode('重新加载', -1)])
                                  ),
                                  _: 1,
                                  __: [2]
                                }
                    ...
                    : plugins.value.length === 0 && !loading.value
                      ? (openBlock(),
                        createElementBlock('div', _hoisted_6, [
                          createVNode(
                            unref(NEmpty),
                            { description: '暂无可用的插件应用' },
                            {
                              extra: withCtx(() => [
                                createVNode(
                                  unref(Button),
                                  ...
                                  {
                                    default: withCtx(
                                      () => _cache[3] || (_cache[3] = [createTextVNode('刷新', -1)])
                                    ),
                                    _: 1,
                                    __: [3]
                                  }
                          ...
                          },
                          {
                            default: withCtx(() => [
                              ...
                              createElementBlock(
                                Fragment,
                                null,
                                renderList(plugins.value, (plugin) => {
                                  return (
                                    openBlock(),
                                    createBlock(
                                      unref(NGridItem),
                                                ...
                                                createBaseVNode('div', _hoisted_7, [
                                                  createBaseVNode('div', _hoisted_8, [
                                                    createBaseVNode(
                                                      'h3',
                                                      _hoisted_9,
                                                      toDisplayString(plugin.config.name),
                                                      1
                                                    ),
                                                    createBaseVNode(
                                                      'p',
                                                      _hoisted_10,
                                                      'v' + toDisplayString(plugin.config.version),
                                                      1
                                                    )
                                                  ]),
                                                  createVNode(
                                              ...
                                              default: withCtx(() => [
                                                createBaseVNode('div', _hoisted_11, [
                                                  createBaseVNode(
                                                    'p',
                                                    _hoisted_12,
                                                    toDisplayString(plugin.config.description),
                                                    1
                                                  ),
                                                  createBaseVNode(
                                                    'p',
                                                    _hoisted_13,
                                                    '作者: ' +
                                                      toDisplayString(plugin.config.author),
                                                    1
                                                  ),
                                                  plugin.config.ui
                                                    ? (openBlock(),
                                                      createElementBlock('div', _hoisted_14, [
                                                        createBaseVNode('div', _hoisted_15, [
                                                          ...
                                                          createBaseVNode(
                                                            ...
                                                            _hoisted_16,
                                                            toDisplayString(
                                                              plugin.config.ui.components?.length ||
                                                                0
                                                            ) + ' 个',
                                                            1
                                                          )
                                                        ]),
                                                        plugin.config.ui.settings
                                                          ? (openBlock(),
                                                            createElementBlock('div', _hoisted_17, [
                                                              ...
                                                              createBaseVNode(
                                                                ...
                                                                _hoisted_18,
                                                                toDisplayString(
                                                                  plugin.config.ui.settings.sections
                                                                    ?.length || 0
                                                                ) + ' 个分组',
                                                                1
                                                              )
