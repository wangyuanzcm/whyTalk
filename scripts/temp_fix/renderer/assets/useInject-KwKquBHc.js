import {
  ...
  F as Fragment,
  ei as ServContactDetail,
  ce as ServContactGroupList,
  ej as ServContactApplyCreate,
  ch as ServContactEditRemark,
  aw as bus,
  ek as ServContactMoveGroup,
  W as _export_sfc,
  aG as useUserStore,
  u as h
          ...
          createBaseVNode('section', _hoisted_2, [
            createBaseVNode('header', _hoisted_3, [
              ...
              createBaseVNode(
                'div',
                _hoisted_5,
                toDisplayString(unref(userInfo).contact_remark || unref(userInfo).nickname || '-'),
                1
              )
            ]),
            createBaseVNode('main', _hoisted_6, [
              createBaseVNode('div', _hoisted_7, [
                ...
                createTextVNode(
                  toDisplayString(unref(userInfo).motto || '编辑个签，展示我的独特态度。'),
                  1
                )
              ]),
              createBaseVNode('div', _hoisted_8, [
                createBaseVNode('div', _hoisted_9, [
                  ...
                  createBaseVNode(
                    'span',
                    _hoisted_10,
                    toDisplayString(unref(formatPhone)(unref(userInfo).mobile) || '-'),
                    1
                  )
                ]),
                createBaseVNode('div', _hoisted_11, [
                  ...
                  createBaseVNode(
                    'span',
                    _hoisted_12,
                    toDisplayString(unref(userInfo).nickname || '-'),
                    1
                  )
                ]),
                createBaseVNode('div', _hoisted_13, [
                  ...
                  createBaseVNode(
                    'span',
                    _hoisted_14,
                    toDisplayString(genders[unref(userInfo).gender]),
                    1
                  )
                ]),
                unref(userInfo).relation === 2
                  ? (openBlock(),
                    createElementBlock('div', _hoisted_15, [
                      _cache[9] ||
                        (_cache[9] = createBaseVNode('span', { class: 'name' }, '备注', -1)),
                      createVNode(
                        ...
                        },
                        {
                          trigger: withCtx(() => [
                            createBaseVNode(
                              'span',
                              _hoisted_16,
                              toDisplayString(unref(userInfo).contact_remark || '-') + '   ',
                              1
                            )
                          ]),
                          header: withCtx(
                            () => _cache[7] || (_cache[7] = [createTextVNode(' 设置备注 ', -1)])
                          ),
                          default: withCtx(() => [
                            createBaseVNode('div', _hoisted_17, [
                              createVNode(
                                _component_n_input,
                                {
                                  ...
                                  'onUpdate:value':
                                    _cache[0] ||
                                    (_cache[0] = ($event) =>
                                      isRef(friendRemark) ? (friendRemark.value = $event) : null),
                              ...
                              createVNode(
                                ...
                                {
                                  default: withCtx(
                                    () => _cache[8] || (_cache[8] = [createTextVNode(' 确定 ', -1)])
                                  ),
                                  _: 1,
                                  __: [8]
                                }
                ...
                createBaseVNode('div', _hoisted_18, [
                  _cache[10] ||
                    (_cache[10] = createBaseVNode('span', { class: 'name' }, '邮箱', -1)),
                  createBaseVNode(
                    'span',
                    _hoisted_19,
                    toDisplayString(unref(userInfo).email || '-'),
                    1
                  )
                ]),
                unref(userInfo).relation === 2
                  ? (openBlock(),
                    createElementBlock('div', _hoisted_20, [
                      _cache[11] ||
                        (_cache[11] = createBaseVNode('span', { class: 'name' }, '分组', -1)),
                      createVNode(
                        ...
                        },
                        {
                          default: withCtx(() => [
                            createBaseVNode(
                              'span',
                              _hoisted_21,
                              toDisplayString(unref(groupName)),
                              1
                            )
                          ]),
                          _: 1
            ...
            [2, 3].includes(unref(userInfo).relation)
              ? (openBlock(),
                createElementBlock('footer', _hoisted_22, [
                  createVNode(
                    _component_n_button,
                    {
                      round: '',
                    ...
                    {
                      icon: withCtx(() => [
                        createVNode(_component_n_icon, { component: unref(SendOne) }, null, 8, [
                          'component'
                        ])
                      ]),
                      default: withCtx(() => [
              ...
              : unref(userInfo).relation === 1
                ? (openBlock(),
                  createElementBlock('footer', _hoisted_23, [
                    unref(isOpenFrom)
                      ? (openBlock(),
                        createElementBlock(
                          Fragment,
                          ...
                          [
                            createVNode(
                              _component_n_input,
                              {
                                ...
                                'onUpdate:value':
                                  _cache[1] ||
                                  (_cache[1] = ($event) =>
                                    isRef(applyRemark) ? (applyRemark.value = $event) : null),
                            ...
                            createVNode(
                              ...
                              {
                                default: withCtx(
                                  () => _cache[13] || (_cache[13] = [createTextVNode(' 确定 ', -1)])
                                ),
                                _: 1,
                                __: [13]
                              },
                      ...
                      : (openBlock(),
                        createBlock(
                          _component_n_button,
                          {
                            ...
                            style: { width: '91%' },
                            onClick:
                              _cache[2] || (_cache[2] = ($event) => (isOpenFrom.value = true))
                          },
                          {
                            default: withCtx(
                              () => _cache[14] || (_cache[14] = [createTextVNode(' 添加好友 ', -1)])
                            ),
                            _: 1,
                            __: [14]
                          }
...
export { ContactConst as C, EditorConst as E, SessionConst as S, useInject as u }
