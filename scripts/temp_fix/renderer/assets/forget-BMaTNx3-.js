          ...
          createBaseVNode('main', _hoisted_2, [
              ...
              },
              {
                default: withCtx(() => [
                      ...
                      default: withCtx(() => [
                        createVNode(
                          _component_n_input,
                          {
                            ...
                            'onUpdate:value':
                              _cache[2] ||
                              (_cache[2] = ($event) => (unref(model).password = $event)),
                            onKeydown: withKeys(onValidate, ['enter'])
                          },
                          null,
                          8,
                  ...
                  createVNode(
                    ...
                    {
                      default: withCtx(
                        () => _cache[5] || (_cache[5] = [createTextVNode(' 立即找回 ', -1)])
                      ),
                      _: 1,
                      __: [5]
                    },
            ...
            createBaseVNode('div', _hoisted_3, [
              createVNode(
                ...
                {
                  default: withCtx(
                    () => _cache[6] || (_cache[6] = [createTextVNode(' 注册账号 ', -1)])
                  ),
                  _: 1,
                  __: [6]
                }
              ...
              createVNode(
                ...
                {
                  default: withCtx(
                    () => _cache[7] || (_cache[7] = [createTextVNode(' 已有账号，立即登录? ', -1)])
                  ),
                  _: 1,
                  __: [7]
                }
