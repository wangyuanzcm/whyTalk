import {
  ...
  cl as ServContactApplyAccept,
  cm as ServContactApplyDecline,
  W as _export_sfc
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives(
        ...
        createElementBlock(
          ...
          [
            withDirectives(
              createVNode(_component_n_empty, { description: '暂无相关数据' }, null, 512),
                        ...
                        [
                          createBaseVNode('div', _hoisted_3, [
                            ...
                            createBaseVNode(
                              'span',
                              _hoisted_4,
                              toDisplayString(unref(formatTime)(item.created_at, 'MM/DD HH:mm')),
                              1
                            )
                          ]),
                          createBaseVNode(
        ...
        createElementBlock('section', _hoisted_1, [
          _cache[0] ||
            (_cache[0] = createBaseVNode(
              'header',
              { class: 'el-header me-view-header border-bottom' },
              '好友通知',
              -1
            )),
          createBaseVNode('main', _hoisted_2, [createVNode(FriendApply)])
        ])
      )
    }
  }
