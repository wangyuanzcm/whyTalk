import {
  ...
  c1 as render,
  ba as inject,
  dK as internalSelectionMenuInjectionKey,
  bj as useMemo,
  br as Transition,
  b4 as NBaseIcon,
  s as cB,
  ...
  bb as useThemeClass,
  bC as nextTick,
  dM as internalSelectionMenuBodyInjectionKey,
  b0 as createInjectionKey,
  d6 as keysOf,
  dN as popselectLight,
  bf as call,
  d8 as omit,
...
const NSelectGroupHeader = defineComponent({
  ...
  setup() {
    const { renderLabelRef, renderOptionRef, labelFieldRef, nodePropsRef } = inject(
...
const NSelectOption = defineComponent({
  ...
  render() {
    ...
    const children = renderLabel
      ...
      : [render(rawNode[this.labelField], rawNode, isSelected), showCheckmark && checkmark]
    const attrs = nodeProps === null || nodeProps === void 0 ? void 0 : nodeProps(rawNode)
    const node = h(
      'div',
      Object.assign({}, attrs, {
        ...
        onMousemove: mergeEventHandlers([
          handleMouseMove,
          attrs === null || attrs === void 0 ? void 0 : attrs.onMousemove
        ])
      }),
      h(
        'div',
    ...
    watch(
      ...
      (show) => {
        if (show) {
          ...
          initPendingNodeWatchStopHandle === null || initPendingNodeWatchStopHandle === void 0
            ? void 0
    ...
    return h(
      ...
      },
      {
        header: () => {
          var _a2, _b
          return (
            ((_b = (_a2 = this.$slots).header) === null || _b === void 0 ? void 0 : _b.call(_a2)) ||
            []
          )
        },
        action: () => {
          var _a2, _b
          return (
            ((_b = (_a2 = this.$slots).action) === null || _b === void 0 ? void 0 : _b.call(_a2)) ||
            []
          )
        },
        empty: () => {
      ...
      internalRenderBody: (className, ref2, style2, onMouseenter, onMouseleave) => {
        ...
        return h(
          ...
          ),
          {
            header: () => {
              var _a, _b
              return (_b = (_a = this.$slots).header) === null || _b === void 0
                ? void 0
                : _b.call(_a)
            },
            action: () => {
