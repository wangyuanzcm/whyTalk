...
const __unplugin_components_3 = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const uncontrolledValueRef = ref(
      (_b = (_a = compitableValueRef.value) !== null && _a !== void 0 ? _a : props.defaultValue) !==
        null && _b !== void 0
        ? _b
        : slots.default
          ? (_d =
              (_c = flatten(slots.default())[0]) === null || _c === void 0 ? void 0 : _c.props) ===
              null || _d === void 0
            ? void 0
            : _d.name
          : null
    ...
    function updateCurrentScrollPosition() {
      ...
      const scrollWrapperEl =
        (_a2 = xScrollInstRef.value) === null || _a2 === void 0 ? void 0 : _a2.$el
      if (!scrollWrapperEl) return
      const tabEl = getCurrentEl()
      if (!tabEl) return
      const { scrollLeft: scrollWrapperElScrollLeft, offsetWidth: scrollWrapperElOffsetWidth } =
        scrollWrapperEl
    ...
    function _handleTabsResize(entry) {
      ...
      deriveScrollShadow(
        ((_a2 = xScrollInstRef.value) === null || _a2 === void 0 ? void 0 : _a2.$el) || null
      )
    }
  ...
  render() {
    ...
    return h(
      ...
      showPane &&
        (this.animated && (resolvedPlacement === 'top' || resolvedPlacement === 'bottom')
          ? h(
              'div',
              {
...
export { NTabPane as N, __unplugin_components_3 as _, __unplugin_components_2 as a }
