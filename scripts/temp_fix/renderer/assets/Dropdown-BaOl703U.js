...
function happensIn(e, dataSetPropName) {
  ...
  while (target) {
    if (target.dataset) {
      if (target.dataset[dataSetPropName] !== void 0) return true
    }
...
function isLeaf(rawNode, getChildren) {
  ...
  if (isLeaf2 !== void 0) return isLeaf2
...
function isShallowLoaded(rawNode, getChildren) {
  const { isLeaf: isLeaf2 } = rawNode
  if (isLeaf2 === false && !Array.isArray(getChildren(rawNode))) return false
  return true
}
...
function getPath(key, { includeGroup = false, includeSelf = true }, treeMate) {
  ...
  let treeNode =
    key === null || key === void 0
      ? null
      : (_a = treeNodeMap.get(key)) !== null && _a !== void 0
        ? _a
        : null
  const mergedPath = {
    keyPath: [],
...
function createTreeMate(rawNodes, options = {}) {
  ...
  const _getChildren =
    (_a = options.getChildren) !== null && _a !== void 0 ? _a : defaultGetChildren
      ...
      return getCheckedKeys(
        {
          ...
          indeterminateKeys: unwrapIndeterminateKeys(checkedKeys),
          keysToUncheck:
            keysToUncheck === null || keysToUncheck === void 0 ? [] : toArray(keysToUncheck),
          cascade,
          leafOnly,
          checkStrategy,
          allowNotLoaded
  ...
  render() {
    ...
    const node = h(
      ...
      Object.assign(
        ...
        nodeProps === null || nodeProps === void 0 ? void 0 : nodeProps(rawNode)
      ),
      h(
        'div',
        {
...
function isSubmenuNode(rawNode, childrenField) {
  return (
    rawNode.type === 'submenu' || (rawNode.type === void 0 && rawNode[childrenField] !== void 0)
  )
}
...
const NDropdownOption = defineComponent({
  ...
  setup(props) {
    ...
    const parentEnteringSubmenuRef = computed(() => {
      return !!(NDropdownOption2 === null || NDropdownOption2 === void 0
        ? void 0
        : NDropdownOption2.enteringSubmenuRef.value)
    })
      ...
      Object.assign(
        {
          class: [
            ...
            optionNodeProps === null || optionNodeProps === void 0 ? void 0 : optionNodeProps.class
          ],
          'data-dropdown-option': true
        },
        optionNodeProps
      ...
      hasSubmenuRef: computed(() => {
        ...
        return props.tmNodes.some((tmNode) => {
          ...
          if (tmNode.isGroup) {
            return (_a = tmNode.children) === null || _a === void 0
              ? void 0
              : _a.some(({ rawNode: rawChild }) => isSubmenuNode(rawChild, childrenField))
          }
          const { rawNode } = tmNode
...
const __unplugin_components_2 = defineComponent({
  ...
  setup(props) {
    ...
    const pendingKeyRef = computed(() => {
      var _a, _b, _c
      return (_c =
        (_b = (_a = hoverKeyRef.value) !== null && _a !== void 0 ? _a : keyboardKeyRef.value) !==
          null && _b !== void 0
          ? _b
    ...
    function handleKeydownEnter() {
      ...
      if (
        (pendingNode === null || pendingNode === void 0 ? void 0 : pendingNode.isLeaf) &&
        mergedShowRef.value
      ) {
    ...
    function handleKeydown(direction) {
      const { value: pendingKey } = pendingKeyRef
      const {
        value: { getFirstAvailableNode: getFirstAvailableNode2 }
      } = treemateRef
