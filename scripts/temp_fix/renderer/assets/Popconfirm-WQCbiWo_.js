...
const PopconfirmPanel = defineComponent({
  ...
  setup(props) {
    ...
    const themeClassHandle = inlineThemeDisabled
      ? useThemeClass('popconfirm-panel', void 0, cssVarsRef, popconfirmProps2)
      : void 0
...
const style = cB('popconfirm', [
 ...
 `,
    [
      ...
      cB('button', [c('&:not(:last-child)', 'margin-right: 8px;')])
    ]
  )
])
    ...
    return h(
      ...
      }),
      {
        ...
        default: () => {
          ...
          return h(
            PopconfirmPanel,
            Object.assign(Object.assign({}, panelProps2), {
