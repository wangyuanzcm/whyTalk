...
const parser = /* @__PURE__ */ LRParser.deserialize({
  ...
  specialized: [
    { term: 116, get: (value) => spec_identifier[value] || -1 },
    { term: 23, get: (value) => spec_AtKeyword[value] || -1 }
  ],
  tokenPrec: 2180
})
...
const lessCompletionSource = /* @__PURE__ */ defineCSSCompletionSource(
  (node) => node.name == 'VariableName' || node.name == 'AtKeyword'
)
function less() {
