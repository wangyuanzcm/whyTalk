...
function tokenize(stream, state) {
  ...
  if (state.inDataStep) {
    ...
    if (
      ...
      (words[word].state.indexOf('inDataStep') !== -1 || words[word].state.indexOf('ALL') !== -1)
    ) {
  ...
  if (state.inProc) {
    ...
    if (
      word &&
      words.hasOwnProperty(word) &&
      (words[word].state.indexOf('inProc') !== -1 || words[word].state.indexOf('ALL') !== -1)
    ) {
      stream.match(/[\w]+/)
      return words[word].style
    }
  ...
  if (state.inMacro) {
    ...
    if (
      word &&
      words.hasOwnProperty(word) &&
      (words[word].state.indexOf('inMacro') !== -1 || words[word].state.indexOf('ALL') !== -1)
    ) {
      stream.match(/[\w]+/)
      return words[word].style
    }
