import {
  en as buildLocalizeFn,
  eo as buildMatchFn,
  ep as buildMatchPatternFn,
  eq as buildFormatLongFn,
  ba as inject,
  z as computed,
...
function useLocale(ns) {
  ...
  const localeRef = computed(() => {
    ...
    return (_b =
      (_a =
        mergedLocaleRef === null || mergedLocaleRef === void 0 ? void 0 : mergedLocaleRef.value) ===
        null || _a === void 0
        ? void 0
...
export { enUS as e, useLocale as u }
