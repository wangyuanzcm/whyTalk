      ...
      return (
        ...
        () => {
          ...
          return h$1(
            t.tag || 'div',
            { ref: s },
            (d = e == null ? void 0 : e.default) == null ? void 0 : d.call(e, u)
          )
        }
      )
    }
            ...
            footer: withCtx(() => [
              createBaseVNode('div', _hoisted_2$1, [
                createVNode(
                  ...
                  {
                    default: withCtx(
                      () => _cache[3] || (_cache[3] = [createTextVNode(' 添加分组 ', -1)])
                    ),
                    _: 1,
                    __: [3]
                  },
                ...
                createBaseVNode('div', null, [
                  ...
                  createVNode(
                    ...
                    {
                      default: withCtx(
                        () => _cache[5] || (_cache[5] = [createTextVNode(' 保存 ', -1)])
                      ),
                      _: 1,
                      __: [5]
                    },
                ...
                createElementBlock('div', _hoisted_1$1, [
                  ...
                  createVNode(
                    unref(lo),
                    {
                      ...
                      'onUpdate:modelValue':
                        _cache[0] ||
                        (_cache[0] = ($event) => (isRef(options) ? (options.value = $event) : null))
                    },
                    {
                      default: withCtx(() => [
                        (openBlock(true),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const onChangeRemark = (data) => {
      let item = items.value.find((item2) => item2.user_id == data.user_id)
          ...
          [
            createBaseVNode('section', _hoisted_1, [
                    ...
                    ? (openBlock(),
                      createBlock(
                        _component_n_tabs,
                        {
                          ...
                          'onUpdate:value':
                            _cache[0] ||
                            (_cache[0] = ($event) => (isRef(index) ? (index.value = $event) : null))
                        },
                        {
                          default: withCtx(() => [
                            (openBlock(true),
              ...
              unref(filter).length
                                ...
                                [
                                  createBaseVNode('div', _hoisted_8, [
                                    createBaseVNode(
                                      'span',
                                      null,
                                      toDisplayString(item.remark || item.nickname),
                                      1
                                    ),
                                  ...
                                  createBaseVNode(
                                    ...
                                    _hoisted_9,
                                    ' 个性签名: ' +
                                      toDisplayString(item.motto ? item.motto : '暂无'),
                                    1
                                  )
                                ],
                                8,
                              ...
                              createBaseVNode('div', _hoisted_10, [
                                createVNode(
                                  ...
                                  },
                                  {
                                    default: withCtx(
                                      () =>
                                        _cache[4] || (_cache[4] = [createTextVNode(' 发消息 ', -1)])
                                    ),
                                    _: 2,
                                    __: [4]
                                  },
                ...
                : withDirectives(
                    (openBlock(),
                    createElementBlock('main', _hoisted_11, [
            ...
            unref(isShowGroupModal)
              ? (openBlock(),
                createBlock(GroupManage, {
                  key: 0,
