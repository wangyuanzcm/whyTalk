      ...
      <nav class="sidebar-nav" role="toolbar">
        ...
        >
          <div class="nav-item">
            ...
            <div class="nav-icon">
              <n-icon :size="menu.size || 18" :component="markRaw(menu.icon)" />
            </div>
...
.layout-sidebar {
  ...
  background: linear-gradient(
    180deg,
    var(--color-bg-sidebar-secondary) 0%,
    var(--color-bg-sidebar-secondary-dark) 100%
  );
...
.layout-content {
  ...
  .content-wrapper {
    ...
    :deep(dt) {
      ...
      font-weight: 600;
      color: var(--color-text-primary);
      background: linear-gradient(90deg, var(--color-primary-alpha-100) 0%, transparent 100%);
    ...
    &::-webkit-scrollbar-thumb {
      background: linear-gradient(
        180deg,
        var(--color-primary-alpha-300),
        var(--color-primary-alpha-400)
      );
      border-radius: var(--border-radius-full);
